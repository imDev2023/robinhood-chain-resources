...
// Vendored verbatim from the pinned v4-core submodule (test/utils/CurrencySettler.sol)
// so production contracts carry no imports from a dependency's test tree.
