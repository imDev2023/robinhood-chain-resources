# Doppler - GitHub whetstoneresearch/doppler-sdk

> Source: https://github.com/whetstoneresearch/doppler-sdk
> Retrieved: 2026-09-02 (Jina Reader, saved as `_raw/jina/ext-gh-doppler-sdk-repo.md`)
> Page title: GitHub - whetstoneresearch/doppler-sdk: A TypeScript SDK for interacting with the Doppler protocol.
...
[](https://github.com/whetstoneresearch/doppler-sdk#overview)
...
[](https://github.com/whetstoneresearch/doppler-sdk#key-features)
...
[](https://github.com/whetstoneresearch/doppler-sdk#installation)
...
[](https://github.com/whetstoneresearch/doppler-sdk#quick-start)
### EVM

[](https://github.com/whetstoneresearch/doppler-sdk#evm)
...
[](https://github.com/whetstoneresearch/doppler-sdk#solana)
...
*   [examples/solana-launch-by-marketcap.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/solana-launch-by-marketcap.ts)
*   [examples/solana-adv-launch.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/solana-adv-launch.ts)
*   [examples/solana-adv-e2e-launch.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/solana-adv-e2e-launch.ts)
*   [examples/solana-cosigner-gated-launch.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/solana-cosigner-gated-launch.ts)
*   [examples/solana-cosigner-gated-buy.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/solana-cosigner-gated-buy.ts)
*   [examples/solana-usdc-e2e-launch.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/solana-usdc-e2e-launch.ts)
*   [examples/solana-usdc-cosigner-gated-buy.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/solana-usdc-cosigner-gated-buy.ts)
*   [examples/solana-prediction-market.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/solana-prediction-market.ts)
*   [examples/solana-swap.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/solana-swap.ts)
*   [examples/solana-vesting-launch.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/solana-vesting-launch.ts)
*   [examples/solana-vesting-claim.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/solana-vesting-claim.ts)

To implement an independently deployed callback program, see [Building a custom Solana hook](https://github.com/whetstoneresearch/doppler-sdk/blob/main/docs/solana-custom-hooks.md) and the [minimal Anchor example](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/solana-custom-hook).
...
The resolver verifies the hook's singleton config and selects its first active Doppler-managed signer. `createLaunch` then pins that signer in the launch's immutable remaining-account commitment without performing an RPC read. Launch creators do not provide or register a cosigner key through this high-level flow. Low-level hook payload and remaining-account helpers accept a cosigner only to reconstruct an already-authorized launch commitment.

Cosigning through Doppler launch hook v1 is a Doppler-managed service. Integrators that require their own cosigner must deploy and use a separate hook program approved by the protocol. Passing a different cosigner to low-level payload or remaining-account helpers does not authorize or register that key with the Doppler-managed hook.

## Creating Auctions

[](https://github.com/whetstoneresearch/doppler-sdk#creating-auctions)
### Static Auction (Fixed Price Range)

[](https://github.com/whetstoneresearch/doppler-sdk#static-auction-fixed-price-range)
...
For a runnable example, see [examples/multicurve-per-beneficiary-vesting.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/multicurve-per-beneficiary-vesting.ts).
...
[](https://github.com/whetstoneresearch/doppler-sdk#static-auction-with-lockable-beneficiaries-v3)
...
See [examples/static-auction-lockable-beneficiaries.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/static-auction-lockable-beneficiaries.ts) for a complete example.

### Dynamic Auction (Dutch Auction)

[](https://github.com/whetstoneresearch/doppler-sdk#dynamic-auction-dutch-auction)
...
[](https://github.com/whetstoneresearch/doppler-sdk#opening-auction-lifecycle--bid-management)
Support includes:
...
See [examples/opening-auction-lifecycle.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/opening-auction-lifecycle.ts) for the full builder/factory/lifecycle flow, and [examples/opening-auction-bidding.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/opening-auction-bidding.ts) for the bid-management pattern + positionId resolution.

### Multicurve Auction (V4 Multicurve Initializer)

[](https://github.com/whetstoneresearch/doppler-sdk#multicurve-auction-v4-multicurve-initializer)
...
By default, each independent multicurve assembly generates a new salt and may predict a different token and pool identity. Supply an explicit 32-byte salt when separate preview and create operations must assemble the same `CreateParams`:
...
Persist and reuse the salt with otherwise identical inputs for a later independent create operation. Builder users can call `.withSalt(salt)` before `.build()`. Omitting the salt, or clearing it with `.withSalt(undefined)`, preserves the generated-salt behavior. Explicit salts must be `0x` followed by exactly 64 hexadecimal characters.
...
See [examples/multicurve-lockable-beneficiaries.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/multicurve-lockable-beneficiaries.ts) for a complete example. See [docs/multicurve-fees.md](https://github.com/whetstoneresearch/doppler-sdk/blob/main/docs/multicurve-fees.md) for single-token and multi-token pending-fee previews, claiming, batching, and current migrated-launch limitations.

#### Transaction gas override

[](https://github.com/whetstoneresearch/doppler-sdk#transaction-gas-override)
...
[](https://github.com/whetstoneresearch/doppler-sdk#builder-pattern-recommended)
...
[](https://github.com/whetstoneresearch/doppler-sdk#simplified-creation-with-defaults)
...
[](https://github.com/whetstoneresearch/doppler-sdk#interacting-with-auctions)
### Static Auction Interactions

[](https://github.com/whetstoneresearch/doppler-sdk#static-auction-interactions)
...
[](https://github.com/whetstoneresearch/doppler-sdk#dynamic-auction-interactions)
...
[](https://github.com/whetstoneresearch/doppler-sdk#multicurve-pool-interactions)
...
See [docs/multicurve-fees.md](https://github.com/whetstoneresearch/doppler-sdk/blob/main/docs/multicurve-fees.md) for a focused guide, [examples/multicurve-get-pending-fees.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/multicurve-get-pending-fees.ts) for batched previews, and [examples/multicurve-collect-fees.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/multicurve-collect-fees.ts) for claims.

## Token Management

[](https://github.com/whetstoneresearch/doppler-sdk#token-management)
### DERC20 Tokens

[](https://github.com/whetstoneresearch/doppler-sdk#derc20-tokens)
...
For a runnable release-focused example covering legacy DERC20, DERC20 V2 schedules, and DopplerERC20V1 partial releases, see [examples/vesting-release.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/vesting-release.ts).

### DopplerERC20V1 Tokens

[](https://github.com/whetstoneresearch/doppler-sdk#dopplererc20v1-tokens)
...
For a runnable example, see [examples/doppler-erc20-v1.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/doppler-erc20-v1.ts).

### Governance Delegation (ERC20Votes)

[](https://github.com/whetstoneresearch/doppler-sdk#governance-delegation-erc20votes)
...
[](https://github.com/whetstoneresearch/doppler-sdk#native-eth)
...
[](https://github.com/whetstoneresearch/doppler-sdk#price-quotes)
...
[](https://github.com/whetstoneresearch/doppler-sdk#atomic-multicurve-dev-buy)
...
See [docs/quotes-and-swaps.md](https://github.com/whetstoneresearch/doppler-sdk/blob/main/docs/quotes-and-swaps.md) and [examples/multicurve-dev-buy-weth.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/multicurve-dev-buy-weth.ts) for complete flows.

## Migration Configuration

[](https://github.com/whetstoneresearch/doppler-sdk#migration-configuration)
The SDK supports flexible migration paths after auction completion:

### Migrate to Uniswap V2

[](https://github.com/whetstoneresearch/doppler-sdk#migrate-to-uniswap-v2)
...
[](https://github.com/whetstoneresearch/doppler-sdk#migrate-to-uniswap-v4)
...
[](https://github.com/whetstoneresearch/doppler-sdk#migrate-to-uniswap-v2-with-proceeds-split--top-ups)
...
[](https://github.com/whetstoneresearch/doppler-sdk#migrate-to-uniswap-v4-with-proceeds-split--top-ups)
...
[](https://github.com/whetstoneresearch/doppler-sdk#topupdistributor-top-ups)
...
[](https://github.com/whetstoneresearch/doppler-sdk#migrate-via-dopplerhookmigrator-dynamic-auctions)
...
Note: `dopplerHookMigrator` beneficiaries must include the current Airlock owner with at least 5% shares, and total shares must sum to `1e18`. Unlike initializer-side Rehype pools, migrator-side Rehype uses a static `customFee`; there is no fee decay schedule in this mode. For backwards compatibility, the deprecated `DopplerHookMigrationConfig` type and its `type: 'dopplerHook'` discriminator remain accepted. New code should use `DopplerHookMigratorConfig` with `type: 'dopplerHookMigrator'`. Multicurve initializer params similarly accept the deprecated `type: 'dopplerHook'` discriminator, which resolves to `dopplerHookInitializer`.
...
[](https://github.com/whetstoneresearch/doppler-sdk#supported-chains)
...
Arbitrum One is available as `CHAIN_IDS.ARBITRUM` (`42161`) with a viem chain definition included in `SupportedChain`.

Robinhood Chain is available as `CHAIN_IDS.ROBINHOOD` (`4663`). The SDK exposes addresses and support checks for it, but does not export a viem chain definition; use your application's chain/client setup when constructing clients.

## Advanced Usage

[](https://github.com/whetstoneresearch/doppler-sdk#advanced-usage)
### Custom Vesting Configuration

[](https://github.com/whetstoneresearch/doppler-sdk#custom-vesting-configuration)
...
[](https://github.com/whetstoneresearch/doppler-sdk#vanity-address-mining)
...
[](https://github.com/whetstoneresearch/doppler-sdk#mining-token-addresses-static-auctions)
...
[](https://github.com/whetstoneresearch/doppler-sdk#mining-hook-and-token-addresses-dynamic-auctions)
...
[](https://github.com/whetstoneresearch/doppler-sdk#mining-token-addresses-multicurve-auctions)
...
[](https://github.com/whetstoneresearch/doppler-sdk#dual-prefix-mining)
...
[](https://github.com/whetstoneresearch/doppler-sdk#mining-notes)
...
[](https://github.com/whetstoneresearch/doppler-sdk#api-reference)
### DopplerSDK

[](https://github.com/whetstoneresearch/doppler-sdk#dopplersdk)
...
[](https://github.com/whetstoneresearch/doppler-sdk#types)
...
[](https://github.com/whetstoneresearch/doppler-sdk#development)
...
[](https://github.com/whetstoneresearch/doppler-sdk#testing)
...
[](https://github.com/whetstoneresearch/doppler-sdk#migration-from-previous-sdks)
If you're migrating from `doppler-v3-sdk` or `doppler-v4-sdk`, see our [Migration Guide](https://github.com/whetstoneresearch/doppler-sdk/blob/main/docs/migration-guide.md).

## Contributing

[](https://github.com/whetstoneresearch/doppler-sdk#contributing)
Contributions are welcome! Please see our [Contributing Guide](https://github.com/whetstoneresearch/doppler-sdk/blob/main/CONTRIBUTING.md) for details.

## License

[](https://github.com/whetstoneresearch/doppler-sdk#license)
MIT License - see [LICENSE](https://github.com/whetstoneresearch/doppler-sdk/LICENSE) for details.

Links/Buttons:
- [Skip to content](https://github.com/whetstoneresearch/doppler-sdk#start-of-content)
- [](https://github.com/whetstoneresearch/doppler-sdk#license)
- [Sign in](https://github.com/login?return_to=https%3A%2F%2Fgithub.com%2Fwhetstoneresearch%2Fdoppler-sdk)
...
- [Sign up](https://github.com/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E&source=header-repo&source_repo=whetstoneresearch%2Fdoppler-sdk)
- [whetstoneresearch](https://github.com/whetstoneresearch)
- [doppler-sdk](https://github.com/whetstoneresearch/doppler-sdk)
- [Notifications](https://github.com/login?return_to=%2Fwhetstoneresearch%2Fdoppler-sdk)
- [Issues 2](https://github.com/whetstoneresearch/doppler-sdk/issues)
- [Pull requests 2](https://github.com/whetstoneresearch/doppler-sdk/pulls)
- [Actions](https://github.com/whetstoneresearch/doppler-sdk/actions)
- [Projects](https://github.com/whetstoneresearch/doppler-sdk/projects)
- [Security and quality 0](https://github.com/whetstoneresearch/doppler-sdk/security)
- [Insights](https://github.com/whetstoneresearch/doppler-sdk/pulse)
- [Branches](https://github.com/whetstoneresearch/doppler-sdk/branches)
- [Tags](https://github.com/whetstoneresearch/doppler-sdk/tags)
- [676 Commits](https://github.com/whetstoneresearch/doppler-sdk/commits/main/)
- [.github/workflows](https://github.com/whetstoneresearch/doppler-sdk/tree/main/.github/workflows)
- [docs](https://github.com/whetstoneresearch/doppler-sdk/tree/main/docs)
- [examples](https://github.com/whetstoneresearch/doppler-sdk/tree/main/examples)
- [scripts](https://github.com/whetstoneresearch/doppler-sdk/tree/main/scripts)
- [src](https://github.com/whetstoneresearch/doppler-sdk/tree/main/src)
- [test](https://github.com/whetstoneresearch/doppler-sdk/tree/main/test)
- [.env.example](https://github.com/whetstoneresearch/doppler-sdk/blob/main/.env.example)
- [.gitattributes](https://github.com/whetstoneresearch/doppler-sdk/blob/main/.gitattributes)
- [.gitignore](https://github.com/whetstoneresearch/doppler-sdk/blob/main/.gitignore)
- [.npmrc](https://github.com/whetstoneresearch/doppler-sdk/blob/main/.npmrc)
- [.oxfmtrc.json](https://github.com/whetstoneresearch/doppler-sdk/blob/main/.oxfmtrc.json)
- [.oxlintrc.json](https://github.com/whetstoneresearch/doppler-sdk/blob/main/.oxlintrc.json)
- [.size-limit.js](https://github.com/whetstoneresearch/doppler-sdk/blob/main/.size-limit.js)
- [AGENTS.md](https://github.com/whetstoneresearch/doppler-sdk/blob/main/AGENTS.md)
- [CONTRIBUTING.md](https://github.com/whetstoneresearch/doppler-sdk/blob/main/CONTRIBUTING.md)
- [LICENSE](https://github.com/whetstoneresearch/doppler-sdk/LICENSE)
- [MIGRATION.md](https://github.com/whetstoneresearch/doppler-sdk/blob/main/MIGRATION.md)
- [README.md](https://github.com/whetstoneresearch/doppler-sdk/blob/main/README.md)
- [package.json](https://github.com/whetstoneresearch/doppler-sdk/blob/main/package.json)
- [pnpm-lock.yaml](https://github.com/whetstoneresearch/doppler-sdk/blob/main/pnpm-lock.yaml)
- [test-v4-deployment.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/test-v4-deployment.ts)
- [tsconfig.examples.json](https://github.com/whetstoneresearch/doppler-sdk/blob/main/tsconfig.examples.json)
- [tsconfig.json](https://github.com/whetstoneresearch/doppler-sdk/blob/main/tsconfig.json)
- [tsconfig.solana-examples.json](https://github.com/whetstoneresearch/doppler-sdk/blob/main/tsconfig.solana-examples.json)
- [tsconfig.test.json](https://github.com/whetstoneresearch/doppler-sdk/blob/main/tsconfig.test.json)
- [tsup.config.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/tsup.config.ts)
- [vitest.config.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/vitest.config.ts)
- [vitest.fork.config.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/vitest.fork.config.ts)
- [vitest.live.config.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/vitest.live.config.ts)
- [vitest.solana.config.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/vitest.solana.config.ts)
- [vitest.unit.config.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/vitest.unit.config.ts)
- [README](https://github.com/whetstoneresearch/doppler-sdk#)
- [examples/solana-launch-by-marketcap.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/solana-launch-by-marketcap.ts)
- [examples/solana-adv-launch.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/solana-adv-launch.ts)
- [examples/solana-adv-e2e-launch.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/solana-adv-e2e-launch.ts)
- [examples/solana-cosigner-gated-launch.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/solana-cosigner-gated-launch.ts)
...
- [examples/solana-vesting-launch.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/solana-vesting-launch.ts)
- [examples/solana-vesting-claim.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/solana-vesting-claim.ts)
- [Building a custom Solana hook](https://github.com/whetstoneresearch/doppler-sdk/blob/main/docs/solana-custom-hooks.md)
- [minimal Anchor example](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/solana-custom-hook)
- [examples/multicurve-per-beneficiary-vesting.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/multicurve-per-beneficiary-vesting.ts)
- [examples/static-auction-lockable-beneficiaries.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/static-auction-lockable-beneficiaries.ts)
- [examples/opening-auction-lifecycle.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/opening-auction-lifecycle.ts)
- [examples/opening-auction-bidding.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/opening-auction-bidding.ts)
- [examples/multicurve-lockable-beneficiaries.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/multicurve-lockable-beneficiaries.ts)
- [docs/multicurve-fees.md](https://github.com/whetstoneresearch/doppler-sdk/blob/main/docs/multicurve-fees.md)
- [examples/multicurve-get-pending-fees.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/multicurve-get-pending-fees.ts)
- [examples/multicurve-collect-fees.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/multicurve-collect-fees.ts)
- [examples/vesting-release.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/vesting-release.ts)
- [examples/doppler-erc20-v1.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/doppler-erc20-v1.ts)
- [docs/quotes-and-swaps.md](https://github.com/whetstoneresearch/doppler-sdk/blob/main/docs/quotes-and-swaps.md)
- [examples/multicurve-dev-buy-weth.ts](https://github.com/whetstoneresearch/doppler-sdk/blob/main/examples/multicurve-dev-buy-weth.ts)
- [Migration Guide](https://github.com/whetstoneresearch/doppler-sdk/blob/main/docs/migration-guide.md)
- [docs.doppler.lol](https://docs.doppler.lol/)
- [Readme](https://github.com/whetstoneresearch/doppler-sdk#readme-ov-file)
- [MIT license](https://github.com/whetstoneresearch/doppler-sdk#MIT-1-ov-file)
- [Contributing](https://github.com/whetstoneresearch/doppler-sdk#contributing-ov-file)
- [Activity](https://github.com/whetstoneresearch/doppler-sdk/activity)
- [Custom properties](https://github.com/whetstoneresearch/doppler-sdk/custom-properties)
- [7 forks](https://github.com/whetstoneresearch/doppler-sdk/forks)
- [Report repository](https://github.com/contact/report-content?content_url=https%3A%2F%2Fgithub.com%2Fwhetstoneresearch%2Fdoppler-sdk&report=whetstoneresearch+%28user%29)
