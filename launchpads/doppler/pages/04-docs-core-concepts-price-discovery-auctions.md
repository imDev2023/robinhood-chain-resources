# Doppler - Price discovery auctions

> Source: https://docs.doppler.lol/core-concepts/price-discovery-auctions
> Retrieved: 2026-09-02 (GitBook .md endpoint, saved as `_raw/jina/docs-core-concepts_price-discovery-auctions.direct.md`)
