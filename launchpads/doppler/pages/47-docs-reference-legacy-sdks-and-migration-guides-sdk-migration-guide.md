# Doppler - Legacy SDK migration guide

> Source: https://docs.doppler.lol/reference/legacy-sdks-and-migration-guides/sdk-migration-guide
> Retrieved: 2026-09-02 (GitBook .md endpoint, saved as `_raw/jina/docs-reference_legacy-sdks-and-migration-guides_sdk-migration-guide.direct.md`)
