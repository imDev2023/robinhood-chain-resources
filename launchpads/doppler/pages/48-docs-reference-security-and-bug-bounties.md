# Doppler - Security & bug bounties

> Source: https://docs.doppler.lol/reference/security-and-bug-bounties
> Retrieved: 2026-09-02 (GitBook .md endpoint, saved as `_raw/jina/docs-reference_security-and-bug-bounties.direct.md`)
