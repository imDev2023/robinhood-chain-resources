# Doppler - Fee Rehypothecation

> Source: https://docs.doppler.lol/advanced-features/rehype-pools
> Retrieved: 2026-09-02 (GitBook .md endpoint, saved as `_raw/jina/docs-advanced-features_rehype-pools.direct.md`)
