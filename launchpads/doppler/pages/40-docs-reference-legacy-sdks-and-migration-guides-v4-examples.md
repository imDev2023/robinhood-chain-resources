...
> Source: https://docs.doppler.lol/reference/legacy-sdks-and-migration-guides/v4/examples
> Retrieved: 2026-09-02 (GitBook .md endpoint, saved as `_raw/jina/docs-reference_legacy-sdks-and-migration-guides_v4_examples.direct.md`)
