# Doppler - Creation & initialization

> Source: https://docs.doppler.lol/core-concepts/creation-and-initialization
> Retrieved: 2026-09-02 (GitBook .md endpoint, saved as `_raw/jina/docs-core-concepts_creation-and-initialization.direct.md`)
