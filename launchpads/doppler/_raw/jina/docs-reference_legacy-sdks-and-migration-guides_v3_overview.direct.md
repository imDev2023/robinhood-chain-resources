> For the complete documentation index, see [llms.txt](https://docs.doppler.lol/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.doppler.lol/reference/legacy-sdks-and-migration-guides/v3/overview.md).
...
For detailed implementation examples, see the [Getting Started Guide](/reference/legacy-sdks-and-migration-guides/v3/getting-started.md) and explore the comprehensive API documentation in the [Factory Reference](/reference/legacy-sdks-and-migration-guides/v3/factory.md).
