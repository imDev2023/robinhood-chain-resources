> For the complete documentation index, see [llms.txt](https://docs.doppler.lol/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.doppler.lol/reference/legacy-sdks-and-migration-guides/v3/custom-fees.md).
...
* [StreamableFeesLocker Reference](/reference/legacy-sdks-and-migration-guides/v4/custom-fees.md)
* [Factory Reference](/reference/legacy-sdks-and-migration-guides/v3/factory.md)
* [V4 SDK Documentation](/reference/legacy-sdks-and-migration-guides/v4/factory.md)
