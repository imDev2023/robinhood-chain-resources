Title: ERC-7631: Dual Nature Token Pair - ERCs - Fellowship of Ethereum Magicians

URL Source: https://ethereum-magicians.org/t/erc-7631-dual-nature-token-pair/18796

Published Time: 2024-02-20T22:08:20+00:00

Markdown Content:
## [](https://ethereum-magicians.org/t/erc-7631-dual-nature-token-pair/18796#p-45937-dual-nature-token-pair-1)Dual Nature Token Pair

requires: ERC-20, ERC-721

## [](https://ethereum-magicians.org/t/erc-7631-dual-nature-token-pair/18796#p-45937-abstract-2)Abstract

A fungible [ERC-20](https://ethereum-magicians.org/t/erc-7631-dual-nature-token-pair/18796) token contract and non-fungible [ERC-721](https://ethereum-magicians.org/t/erc-7631-dual-nature-token-pair/18796) token contract can be interlinked, allowing actions performed on one contract to be reflected on the other. This proposal defines how the relationship between the two token contracts can be queried. It also enables accounts to configure if ERC-721 mints and transfers should be skipped during ERC-20 to ERC-721 synchronization.

## [](https://ethereum-magicians.org/t/erc-7631-dual-nature-token-pair/18796#p-45937-motivation-3)Motivation
...
## [](https://ethereum-magicians.org/t/erc-7631-dual-nature-token-pair/18796#p-45937-specification-4)Specification

The key words “MUST”, “MUST NOT”, “REQUIRED”, “SHALL”, “SHALL NOT”, “SHOULD”, “SHOULD NOT”, “RECOMMENDED”, “NOT RECOMMENDED”, “MAY”, and “OPTIONAL” in this document are to be interpreted as described in RFC 2119 and RFC 8174.

### [](https://ethereum-magicians.org/t/erc-7631-dual-nature-token-pair/18796#p-45937-overview-5)Overview
...
### [](https://ethereum-magicians.org/t/erc-7631-dual-nature-token-pair/18796#p-45937-erc-20-extension-interface-6)ERC-20 Extension Interface
...
### [](https://ethereum-magicians.org/t/erc-7631-dual-nature-token-pair/18796#p-45937-erc-721-extension-interface-7)ERC-721 Extension Interface
...
## [](https://ethereum-magicians.org/t/erc-7631-dual-nature-token-pair/18796#p-45937-rationale-8)Rationale

### [](https://ethereum-magicians.org/t/erc-7631-dual-nature-token-pair/18796#p-45937-implementation-detection-9)Implementation Detection

The `mirrorERC721` and `baseERC20` methods returning non-zero addresses suffice to signal that the contracts implement the required interfaces. As such, [ERC-165](https://ethereum-magicians.org/t/erc-7631-dual-nature-token-pair/18796) is not required.
...
### [](https://ethereum-magicians.org/t/erc-7631-dual-nature-token-pair/18796#p-45937-nft-skipping-10)NFT Skipping
...
### [](https://ethereum-magicians.org/t/erc-7631-dual-nature-token-pair/18796#p-45937-implementation-conventions-11)Implementation Conventions
...
### [](https://ethereum-magicians.org/t/erc-7631-dual-nature-token-pair/18796#p-45937-linking-mechanism-12)Linking Mechanism
...
## [](https://ethereum-magicians.org/t/erc-7631-dual-nature-token-pair/18796#p-45937-backwards-compatibility-13)Backwards Compatibility

No backward compatibility issues found.

## [](https://ethereum-magicians.org/t/erc-7631-dual-nature-token-pair/18796#p-45937-security-considerations-14)Security Considerations

### [](https://ethereum-magicians.org/t/erc-7631-dual-nature-token-pair/18796#p-45937-synchronization-access-guards-15)Synchronization Access Guards

External methods for synchronization logic must be guarded such that only the other contract is authorized to call them.

### [](https://ethereum-magicians.org/t/erc-7631-dual-nature-token-pair/18796#p-45937-rare-nft-sniping-16)Rare NFT Sniping
...
### [](https://ethereum-magicians.org/t/erc-7631-dual-nature-token-pair/18796#p-45937-out-of-gas-denial-of-service-17)Out-of-gas Denial of Service
...
## [](https://ethereum-magicians.org/t/erc-7631-dual-nature-token-pair/18796#p-45937-implementations-18)Implementations

Links/Buttons:
- [2](https://ethereum-magicians.org/u/fulldecent)
- [3](https://ethereum-magicians.org/u/xinbenlv)
- [12](https://ethereum-magicians.org/u/Vectorized)
- [Skip to last reply](https://ethereum-magicians.org/t/erc-7631-dual-nature-token-pair/18796/38)
- [Skip to top](https://ethereum-magicians.org/t/erc-7631-dual-nature-token-pair/18796/1)
- [Skip to main content](https://ethereum-magicians.org/t/erc-7631-dual-nature-token-pair/18796#main-container)
- [](https://ethereum-magicians.org/t/erc-7631-dual-nature-token-pair/18796#p-45937-implementations-18)
- [ERC-7631: Dual Nature Token Pair](https://ethereum-magicians.org/t/erc-7631-dual-nature-token-pair/18796)
- [ERCs](https://ethereum-magicians.org/c/ercs/57)
- [erc](https://ethereum-magicians.org/tag/erc)
- [erc-721](https://ethereum-magicians.org/tag/erc-721)
- [erc20](https://ethereum-magicians.org/tag/erc20)
- [github.com](https://github.com/Vectorized/dn404)
- [ERC-7647: Fungible NFTs](https://ethereum-magicians.org/t/erc-7647-fungible-nfts/19056/4)
- [Discussion on ERC-7583 for Inscribing assets in smart contract](https://ethereum-magicians.org/t/discussion-on-erc-7583-for-inscribing-assets-in-smart-contract/17661/109)
