# HoodCustomLaunchpad - 0x8c529f0a77c07ce0e6796f153d292501ee6f66f6

Role: HoodCustomLaunchpad-v2-default.
Address: `0x8c529f0a77c07ce0e6796f153d292501ee6f66f6` on Robinhood Chain (chain id 4663).
Blockscout: https://robinhoodchain.blockscout.com/address/0x8c529f0a77c07ce0e6796f153d292501ee6f66f6
...
Raw constructor args: `0x0000000000000000000000008bceaa40b9acdfaedf85adf4ff01f5ad6517937f0000000000000000000000000bd7d308f8e1639fab988df18a8011f41eacad73000000000000000000000000159089f48b4f0e51f430f7df6fe1064bec0258df`.
...
- `migrationTerms(address token)` -> uint64, uint16, uint128, bool [view]
- `migrator()` -> address [view]
- `migratorUnlockAt()` -> uint256 [view]
- `owner()` -> address [view]
- `pendingCreatorClaim(address creator)` -> uint256 [view]
- `pendingMigrator()` -> address [view]
...
- `proposeMigrator(address migrator_)` ->  [nonpayable]
...
- `MigratorChangeCancelled(address migrator)`
- `MigratorProposed(address migrator, uint256 unlockAt)`
