...
```
GET https://whitepaper.virtuals.io/about-virtuals-1/what-are-virtual-agents-autonomous-ai-agents/ip-agents-vs-functional-agents/g.a.m.e.-functional-ai-agent-framework.md?ask=<question>&goal=<endgoal>
```
