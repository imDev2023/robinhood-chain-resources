> For the complete documentation index, see [llms.txt](https://whitepaper.virtuals.io/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://whitepaper.virtuals.io/about-virtuals-1/what-are-virtual-agents-autonomous-ai-agents/ip-agents-vs-functional-agents.md).
...
```
GET https://whitepaper.virtuals.io/about-virtuals-1/what-are-virtual-agents-autonomous-ai-agents/ip-agents-vs-functional-agents.md?ask=<question>&goal=<endgoal>
```
