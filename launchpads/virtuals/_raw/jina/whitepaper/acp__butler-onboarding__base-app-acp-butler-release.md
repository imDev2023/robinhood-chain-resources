> For the complete documentation index, see [llms.txt](https://whitepaper.virtuals.io/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://whitepaper.virtuals.io/acp/butler-onboarding/base-app-acp-butler-release.md).
...
```
GET https://whitepaper.virtuals.io/acp/butler-onboarding/base-app-acp-butler-release.md?ask=<question>&goal=<endgoal>
```
