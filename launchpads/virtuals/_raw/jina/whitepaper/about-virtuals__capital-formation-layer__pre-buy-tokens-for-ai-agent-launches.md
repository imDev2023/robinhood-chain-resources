> For the complete documentation index, see [llms.txt](https://whitepaper.virtuals.io/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://whitepaper.virtuals.io/about-virtuals/capital-formation-layer/pre-buy-tokens-for-ai-agent-launches.md).
...
```
GET https://whitepaper.virtuals.io/about-virtuals/capital-formation-layer/pre-buy-tokens-for-ai-agent-launches.md?ask=<question>&goal=<endgoal>
```
