# Virtuals Protocol - $VIRTUAL Token Distribution and Tokenomics

> Source: https://whitepaper.virtuals.io/info-hub/usdvirtual-token-base-asset-for-ai-agents/usdvirtual-token-distribution-and-tokenomics
...
```
GET https://whitepaper.virtuals.io/info-hub/usdvirtual-token-base-asset-for-ai-agents/usdvirtual-token-distribution-and-tokenomics.md?ask=<question>&goal=<endgoal>
```
