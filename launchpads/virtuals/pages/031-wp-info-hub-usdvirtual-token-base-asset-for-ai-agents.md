# Virtuals Protocol - $VIRTUAL Token: Base Asset for AI Agents

> Source: https://whitepaper.virtuals.io/info-hub/usdvirtual-token-base-asset-for-ai-agents
...
```
GET https://whitepaper.virtuals.io/info-hub/usdvirtual-token-base-asset-for-ai-agents.md?ask=<question>&goal=<endgoal>
```
