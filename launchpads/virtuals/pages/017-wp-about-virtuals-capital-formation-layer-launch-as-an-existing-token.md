# Virtuals Protocol - Launch as an Existing Token

> Source: https://whitepaper.virtuals.io/about-virtuals/capital-formation-layer/launch-as-an-existing-token
...
```
GET https://whitepaper.virtuals.io/about-virtuals/capital-formation-layer/launch-as-an-existing-token.md?ask=<question>&goal=<endgoal>
```
