# Virtuals Protocol - $VIRTUAL 代币：AI 智能体的基础资产

> Source: https://whitepaper.virtuals.io/virtuals-bai-pi-shu/xin-xi-zhong-xin/virtual-dai-bi-ai-zhi-neng-ti-de-ji-chu-zi-chan
> Retrieved: 2026-09-02 (GitBook .md endpoint via curl)

---

# $VIRTUAL 代币：AI 智能体的基础资产
...
* [**代币分配**](/virtuals-bai-pi-shu/xin-xi-zhong-xin/virtual-dai-bi-ai-zhi-neng-ti-de-ji-chu-zi-chan/virtual-dai-bi-fen-pei-yu-dai-bi-jing-ji-xue.md)：查看 $VIRTUAL 的供应分配和生态系统金库分配。
...
```
GET https://whitepaper.virtuals.io/virtuals-bai-pi-shu/xin-xi-zhong-xin/virtual-dai-bi-ai-zhi-neng-ti-de-ji-chu-zi-chan.md?ask=<question>&goal=<endgoal>
```
