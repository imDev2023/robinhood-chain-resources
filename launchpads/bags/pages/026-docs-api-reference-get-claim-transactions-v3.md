# Bags - Get Claim Transactions (v3)

> Source: https://docs.bags.fm/api-reference/get-claim-transactions-v3
> Retrieved: 2026-09-02 (Mintlify markdown export, curl https://docs.bags.fm/api-reference/get-claim-transactions-v3.md)
