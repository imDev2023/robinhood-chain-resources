# Bags - Send Transaction

> Source: https://docs.bags.fm/api-reference/send-transaction
> Retrieved: 2026-09-02 (Mintlify markdown export, curl https://docs.bags.fm/api-reference/send-transaction.md)
...
````yaml POST /solana/send-transaction
openapi: 3.1.0
info:
...
paths:
  /solana/send-transaction:
    post:
      ...
      description: Submit a signed Bags Solana transaction to the network for execution.
      requestBody:
        required: true
        content:
          application/json:
