# Bags - Create Dexscreener Order

> Source: https://docs.bags.fm/api-reference/create-dexscreener-order
> Retrieved: 2026-09-02 (Mintlify markdown export, curl https://docs.bags.fm/api-reference/create-dexscreener-order.md)
