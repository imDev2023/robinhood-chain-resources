# Bags - Get Robinhood Trade History

> Source: https://docs.bags.fm/api-reference/get-rh-trades
> Retrieved: 2026-09-02 (Mintlify markdown export, curl https://docs.bags.fm/api-reference/get-rh-trades.md)
