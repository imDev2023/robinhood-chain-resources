# Bags - Get Index Token Statuses

> Source: https://docs.bags.fm/api-reference/get-rh-index-token-status
> Retrieved: 2026-09-02 (Mintlify markdown export, curl https://docs.bags.fm/api-reference/get-rh-index-token-status.md)
