# Bags - Get Robinhood Token State

> Source: https://docs.bags.fm/api-reference/get-rh-token-state
> Retrieved: 2026-09-02 (Mintlify markdown export, curl https://docs.bags.fm/api-reference/get-rh-token-state.md)
