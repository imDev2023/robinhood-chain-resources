# Bags - Get Pool Config Keys by Fee Claimer Vaults

> Source: https://docs.bags.fm/api-reference/get-pool-config-keys
> Retrieved: 2026-09-02 (Mintlify markdown export, curl https://docs.bags.fm/api-reference/get-pool-config-keys.md)
