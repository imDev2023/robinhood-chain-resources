# Bags - Get Claim Transactions

> Source: https://docs.bags.fm/api-reference/get-claim-transactions
> Retrieved: 2026-09-02 (Mintlify markdown export, curl https://docs.bags.fm/api-reference/get-claim-transactions.md)
