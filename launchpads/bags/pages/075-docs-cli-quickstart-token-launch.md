# Bags - Quickstart: Launch a Token

> Source: https://docs.bags.fm/cli/quickstart-token-launch
> Retrieved: 2026-09-02 (Mintlify markdown export, curl https://docs.bags.fm/cli/quickstart-token-launch.md)
