# Bags - Get Fee Share Admin List

> Source: https://docs.bags.fm/api-reference/get-fee-share-admin-list
> Retrieved: 2026-09-02 (Mintlify markdown export, curl https://docs.bags.fm/api-reference/get-fee-share-admin-list.md)
