# Bags - Get EVM Token Creators

> Source: https://docs.bags.fm/api-reference/get-evm-token-creator
> Retrieved: 2026-09-02 (Mintlify markdown export, curl https://docs.bags.fm/api-reference/get-evm-token-creator.md)
