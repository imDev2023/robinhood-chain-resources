# Bags - Initialize Index Token

> Source: https://docs.bags.fm/api-reference/init-rh-index-token
> Retrieved: 2026-09-02 (Mintlify markdown export, curl https://docs.bags.fm/api-reference/init-rh-index-token.md)
