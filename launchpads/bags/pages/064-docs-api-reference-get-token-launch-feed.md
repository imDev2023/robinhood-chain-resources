# Bags - Get Token Launch Feed

> Source: https://docs.bags.fm/api-reference/get-token-launch-feed
> Retrieved: 2026-09-02 (Mintlify markdown export, curl https://docs.bags.fm/api-reference/get-token-launch-feed.md)
