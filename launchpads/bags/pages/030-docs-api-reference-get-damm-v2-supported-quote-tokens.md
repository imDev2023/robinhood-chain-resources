# Bags - Get DAMM v2 Supported Quote Tokens

> Source: https://docs.bags.fm/api-reference/get-damm-v2-supported-quote-tokens
> Retrieved: 2026-09-02 (Mintlify markdown export, curl https://docs.bags.fm/api-reference/get-damm-v2-supported-quote-tokens.md)
