# Bags - Get Robinhood Creation Fee

> Source: https://docs.bags.fm/api-reference/get-rh-creation-fee
> Retrieved: 2026-09-02 (Mintlify markdown export, curl https://docs.bags.fm/api-reference/get-rh-creation-fee.md)

---

# Get Robinhood Creation Fee
...
paths:
  /evm/rh/creation-fee:
    get:
      tags:
        - Robinhood Chain
      summary: Get creation fee
      description: >-
        Get the current token creation fee on the Bags V2 factory on Robinhood
        Chain.
      parameters: []
      responses:
        '200':
          description: Successfully retrieved creation fee
          content:
            application/json:
              schema:
                allOf:
                  ...
                  - type: object
                    properties:
                      response:
                        $ref: '#/components/schemas/RhCreationFee'
        '400':
    ...
    RhCreationFee:
      ...
      properties:
        creationFeeWei:
          type: string
          description: >-
            Current token creation fee on the V2 factory (wei), as string to
            support bigint.
      required:
        - creationFeeWei
    RhErrorResponse:
