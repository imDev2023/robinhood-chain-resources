# Bags - Get Index Token History

> Source: https://docs.bags.fm/api-reference/get-rh-index-token-history
> Retrieved: 2026-09-02 (Mintlify markdown export, curl https://docs.bags.fm/api-reference/get-rh-index-token-history.md)
