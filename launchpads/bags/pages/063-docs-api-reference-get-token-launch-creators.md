# Bags - Get Token Launch Creators

> Source: https://docs.bags.fm/api-reference/get-token-launch-creators
> Retrieved: 2026-09-02 (Mintlify markdown export, curl https://docs.bags.fm/api-reference/get-token-launch-creators.md)
