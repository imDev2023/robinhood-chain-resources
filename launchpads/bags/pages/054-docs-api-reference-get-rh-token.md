# Bags - Get Robinhood Token

> Source: https://docs.bags.fm/api-reference/get-rh-token
> Retrieved: 2026-09-02 (Mintlify markdown export, curl https://docs.bags.fm/api-reference/get-rh-token.md)
