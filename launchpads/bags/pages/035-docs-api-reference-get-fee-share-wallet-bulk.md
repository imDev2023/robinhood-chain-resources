# Bags - Get Fee Share Wallet V2 (Bulk)

> Source: https://docs.bags.fm/api-reference/get-fee-share-wallet-bulk
> Retrieved: 2026-09-02 (Mintlify markdown export, curl https://docs.bags.fm/api-reference/get-fee-share-wallet-bulk.md)
