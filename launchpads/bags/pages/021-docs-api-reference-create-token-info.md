# Bags - Create Token Info and Metadata

> Source: https://docs.bags.fm/api-reference/create-token-info
> Retrieved: 2026-09-02 (Mintlify markdown export, curl https://docs.bags.fm/api-reference/create-token-info.md)
