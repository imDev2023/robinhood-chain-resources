# Bags - Check Dexscreener Order Availability

> Source: https://docs.bags.fm/api-reference/get-dexscreener-order-availability
> Retrieved: 2026-09-02 (Mintlify markdown export, curl https://docs.bags.fm/api-reference/get-dexscreener-order-availability.md)
...
````yaml GET /solana/dexscreener/order-availability
openapi: 3.1.0
info:
...
paths:
  /solana/dexscreener/order-availability:
    get:
      tags:
        - Dexscreener
      summary: Check Dexscreener order availability
      description: >-
        Check whether a Dexscreener token info order is available for a given
        token.
      parameters:
        - name: tokenAddress
          in: query
      ...
      responses:
        '200':
          description: Successfully checked order availability
          content:
            application/json:
              schema:
                allOf:
                      ...
                      response:
                        ...
                        properties:
                          available:
                            type: boolean
                            description: >-
                              Whether a Dexscreener order can be placed for this
                              token
                        required:
                          - available
        '400':
