# Bags - Create Fee Share Admin Transfer Transaction

> Source: https://docs.bags.fm/api-reference/create-fee-share-admin-transfer-tx
> Retrieved: 2026-09-02 (Mintlify markdown export, curl https://docs.bags.fm/api-reference/create-fee-share-admin-transfer-tx.md)
