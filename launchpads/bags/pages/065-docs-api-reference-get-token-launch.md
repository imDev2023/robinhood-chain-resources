# Bags - Get Token Launch

> Source: https://docs.bags.fm/api-reference/get-token-launch
> Retrieved: 2026-09-02 (Mintlify markdown export, curl https://docs.bags.fm/api-reference/get-token-launch.md)
