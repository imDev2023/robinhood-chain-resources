# Bags - Create Fee Share Config creation transaction

> Source: https://docs.bags.fm/api-reference/create-fee-share-configuration
> Retrieved: 2026-09-02 (Mintlify markdown export, curl https://docs.bags.fm/api-reference/create-fee-share-configuration.md)
