...
paths:
  /fee-share/admin/list:
    get:
      tags:
        - Fee Share Admin
      summary: List tokens where wallet is fee share admin
      description: >-
        Returns a list of token mints where the given wallet is the fee share
        admin.
      parameters:
        - name: wallet
          in: query
          ...
          schema:
            type: string
          description: Public key of the wallet to check admin status for
      responses:
        '200':
          description: Successfully retrieved admin token list
          content:
            application/json:
              schema:
                allOf:
                  ...
                  - type: object
                    properties:
                      response:
                        $ref: '#/components/schemas/FeeShareAdminListResponse'
        '400':
      ...
      properties:
        tokenMints:
          ...
          items:
            type: string
          description: >-
            Array of token mint public keys where the wallet is the fee share
            admin
      required:
        - tokenMints
    ErrorResponse:
