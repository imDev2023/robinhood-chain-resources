...
URL Source: https://fun.noxa.fi/docs
...
There's **no launch fee**. The token's full supply (1,000,000,000) is minted and deposited as a single-sided Uniswap V3 liquidity position — no team allocation, no presale. That LP position is then**locked forever**, so the liquidity can never be pulled.
