...
URL Source: https://docs.ponsfamily.com/docs
...
Price impact The pool movement caused by the size of your trade.

Slippage The maximum execution movement your transaction accepts.
...
Current launches Creator 70% · protocol 30% · from block 8991118

Legacy launches Creator 90% · protocol 10% · from block 8600612
...
Buyback 80% of protocol fees, executed as an automated TWAP

Operations 20% of protocol fees toward infrastructure and team
...
Takeovers are requested through the[pons CTO form](https://forms.gle/JjrWvybFeNfE5v8F6)and reviewed by the team. Use it only when a token has been clearly abandoned by its original creator and an active community is requesting control of the creator-fee recipient.
...
Reach us at[contact@ponsfamily.com](mailto:contact@ponsfamily.com) for integration questions, technical support, and partnership requests.
...
- [Overview](https://docs.ponsfamily.com/docs#overview)
- [Launch mechanism](https://docs.ponsfamily.com/docs#launches)
- [Trading and pricing](https://docs.ponsfamily.com/docs#trading)
- [Graduation](https://docs.ponsfamily.com/docs#graduation)
- [Fees and burns](https://docs.ponsfamily.com/docs#fees)
- [Protocol revenue](https://docs.ponsfamily.com/docs#revenue)
- [Community takeovers](https://docs.ponsfamily.com/docs#cto)
- [Risk disclosures](https://docs.ponsfamily.com/docs#risks)
- [Network](https://docs.ponsfamily.com/docs#network)
- [Contracts](https://docs.ponsfamily.com/docs#contracts)
- [Onchain events](https://docs.ponsfamily.com/docs#events)
- [Reading token state](https://docs.ponsfamily.com/docs#state)
- [Pricing and graduation](https://docs.ponsfamily.com/docs#pricing)
- [Reference token](https://docs.ponsfamily.com/docs#reference)
- [Support](https://docs.ponsfamily.com/docs#support)
- [Terms and attribution](https://docs.ponsfamily.com/docs#terms)
