...
URL Source: https://docs.ponsfamily.com/docs/v2
...
The one payout that does not arrive in the pairing asset is the buyback. Buybacks purchase the launch token itself, so what you eventually receive from one is that token. See[buyback and vesting](https://docs.ponsfamily.com/docs/v2#buyback).
...
Only buys carry the snipe tax. Read`currentSnipeTaxBps(recipient)` keyed to the wallet that will receive the tokens, since exemptions are held per recipient, and expect it to be large in the opening seconds of a launch. See[snipe protection](https://docs.ponsfamily.com/docs/v2#snipe-protection).
...
`3` Rescued Recovery path used. Off the normal path, and worth surfacing explicitly. See [safety and recovery](https://docs.ponsfamily.com/docs/v2#safety).
...
*   v2 is deployed and the addresses are listed under[contracts](https://docs.ponsfamily.com/docs/v2#contracts). Public launches are closed, so only whitelisted addresses can create a token for now. Check`canLaunch(address)` rather than assuming.
...
- [Overview](https://docs.ponsfamily.com/docs/v2#overview)
- [Launch lifecycle](https://docs.ponsfamily.com/docs/v2#lifecycle)
- [Bonding curve](https://docs.ponsfamily.com/docs/v2#curve)
- [Graduation](https://docs.ponsfamily.com/docs/v2#graduation)
- [Custom pairs](https://docs.ponsfamily.com/docs/v2#custom-pairs)
- [Snipe protection](https://docs.ponsfamily.com/docs/v2#snipe-protection)
- [Fees](https://docs.ponsfamily.com/docs/v2#fees)
- [Payouts](https://docs.ponsfamily.com/docs/v2#payouts)
- [Buyback and vesting](https://docs.ponsfamily.com/docs/v2#buyback)
- [Creator controls](https://docs.ponsfamily.com/docs/v2#creator-controls)
- [Community takeovers](https://docs.ponsfamily.com/docs/v2#cto)
- [Migration](https://docs.ponsfamily.com/docs/v2#migration)
- [Safety and recovery](https://docs.ponsfamily.com/docs/v2#safety)
- [Risk disclosures](https://docs.ponsfamily.com/docs/v2#risks)
- [Contracts](https://docs.ponsfamily.com/docs/v2#contracts)
- [Launching a token](https://docs.ponsfamily.com/docs/v2#launching)
- [Buying and selling](https://docs.ponsfamily.com/docs/v2#trading)
- [Getting a quote](https://docs.ponsfamily.com/docs/v2#quoting)
- [Reading state](https://docs.ponsfamily.com/docs/v2#reads)
- [Claiming fees](https://docs.ponsfamily.com/docs/v2#claiming)
- [Events to index](https://docs.ponsfamily.com/docs/v2#events)
- [Uniswap v4 pools](https://docs.ponsfamily.com/docs/v2#uniswap-v4)
- [Errors](https://docs.ponsfamily.com/docs/v2#errors)
- [Audits](https://docs.ponsfamily.com/docs/v2#audits)
- [Support](https://docs.ponsfamily.com/docs/v2#support)
