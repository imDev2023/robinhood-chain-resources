...
/**
 * @title V2LaunchLocker
 * @notice Permanently holds the graduated Uniswap V4 position NFT for every
 * launchpad v2 launch. Unlike v1's locker, there is no `collectFees()` here: fee
 * collection and distribution belong entirely to V2MemeHook and
 * V2FeeEscrow, since a V4 position accrues fees inside the singleton
 ...
 */
contract V2LaunchLocker is Ownable2Step, IERC721ReceiverLike {
