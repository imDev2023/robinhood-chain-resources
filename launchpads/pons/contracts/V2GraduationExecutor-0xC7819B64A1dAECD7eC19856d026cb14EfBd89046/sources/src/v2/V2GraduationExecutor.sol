...
import {V2LaunchLocker} from "./V2LaunchLocker.sol";

/**
 * @title V2GraduationExecutor
 * @notice Performs the two heaviest steps of launchpad v2 graduation on
 * V2LaunchFactory's behalf: swapping swept ETH for a non-native
 * pairToken, and minting the full-range Uniswap V4 position. Split out into
 * its own contract purely so V2LaunchFactory's own bytecode stays under
...
contract V2GraduationExecutor {
    ...
    V2LaunchLocker public immutable locker;
