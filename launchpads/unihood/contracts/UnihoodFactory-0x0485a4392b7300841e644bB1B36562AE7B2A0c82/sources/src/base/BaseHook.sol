...
/// @title BaseHook
/// @notice Minimal IHooks scaffold: routes PoolManager callbacks to internal virtuals and
///         validates that the deployed address encodes exactly the declared permissions.
abstract contract BaseHook is IHooks {
    ...
    function beforeDonate(address sender, PoolKey calldata key, uint256 amount0, uint256 amount1, bytes calldata data)
        ...
        returns (bytes4)
    {
        return _beforeDonate(sender, key, amount0, amount1, data);
    }
