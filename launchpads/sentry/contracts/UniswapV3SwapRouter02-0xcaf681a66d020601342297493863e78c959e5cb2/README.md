...
Role: UniswapV3SwapRouter02.
Contract name: SwapRouter02.
Verified: True (verified at 2026-05-22T18:40:32.297992Z).
...
`v3Router()` on the treasury splitter, used to buy SENTRY with protocol fees.
