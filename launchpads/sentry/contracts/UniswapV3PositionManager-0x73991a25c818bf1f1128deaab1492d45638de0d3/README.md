...
Role: UniswapV3PositionManager.
Contract name: NonfungiblePositionManager.
Verified: True (verified at 2026-05-22T18:40:11.609746Z).
...
`npm()` on the legacy factory and `v3Npm()` on the LP vault; holds the 93 locked legacy positions.
