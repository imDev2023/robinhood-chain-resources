# Sentry - Discover, the token list at sentry.trading

> Source: https://www.sentry.trading/
> Retrieved: 2026-09-02 (Jina Reader)
> Raw capture: `_raw/jina/sentry-root.md`

---

The app is a single-page React app. `/` and `/desktop/tokens` render the same Discover list.
...
Screenshots: `screenshots/01-sentry-root-tokens.png`.
