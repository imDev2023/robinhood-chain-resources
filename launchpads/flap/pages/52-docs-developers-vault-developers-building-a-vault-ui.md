# Flap - Building a Vault UI

> Source: https://docs.flap.sh/flap/developers/vault-developers/building-a-vault-ui
> Retrieved: 2026-09-02 (GitBook markdown export, https://docs.flap.sh/flap/developers/vault-developers/building-a-vault-ui.md)
