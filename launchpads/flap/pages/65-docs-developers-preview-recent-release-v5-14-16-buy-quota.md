# Flap - Buy Quota (v5.14.16)

> Source: https://docs.flap.sh/flap/developers/preview/recent-release/v5.14.16-buy-quota
> Retrieved: 2026-09-02 (GitBook markdown export, https://docs.flap.sh/flap/developers/preview/recent-release/v5.14.16-buy-quota.md)
