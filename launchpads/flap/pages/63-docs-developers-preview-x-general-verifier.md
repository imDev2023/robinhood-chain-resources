# Flap - X General Verifier

> Source: https://docs.flap.sh/flap/developers/preview/x-general-verifier
> Retrieved: 2026-09-02 (GitBook markdown export, https://docs.flap.sh/flap/developers/preview/x-general-verifier.md)
