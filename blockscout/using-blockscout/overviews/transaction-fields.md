...
# Transaction Fields Reference: Hash, Gas, Logs, State

> Reference guide to Blockscout transaction page fields including hash, status, gas, nonce, input data, token transfers, event logs, and state changes.

# Blockscout Transaction Fields Reference Guide

Example transaction on Ethereum

<img src="https://mintcdn.com/blockscout/GHvuDaE4gRKuNH6O/images/example-transaction.jpg?fit=max&auto=format&n=GHvuDaE4gRKuNH6O&q=85&s=3fe20d18066695c4e176ed41861f253c" alt="Blockscout Ethereum transaction details page showing 0.0019 ETH transfer from Huobi Deposit Funder 7 to wallet address, with transaction hash, block confirmations, timestamp, and navigation tabs for token transfers, logs, and state changes" width="2168" height="1318" data-path="images/example-transaction.jpg" />
...
| Type 3               | EIP-4844<br />(Blobs)                  | Blob carrying transaction      | Accommodate batched data                   |
