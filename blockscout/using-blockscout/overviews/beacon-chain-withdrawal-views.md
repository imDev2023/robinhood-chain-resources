...
# Beacon Chain Withdrawal Views in Blockscout

> See how Blockscout displays Ethereum beacon chain validator withdrawals on block and address pages, including index, validator index, amount, and recipient.
...
The unique `index`, assigned `validatorIndex`, withdrawal receiving `address`, and `amount` are all included in the withdrawals structure and are displayed on Blockscout on the block and addresses pages.
...
<Accordion title="Example block with withdrawal struct">
  ```json theme={null}
  {
      "jsonrpc": "2.0",
      "id": 1,
...
<Frame>
  <img src="https://mintcdn.com/blockscout/JTppjXqh5Q4u166M/images/12f8357f-image.jpeg?fit=max&auto=format&n=JTppjXqh5Q4u166M&q=85&s=68be5feddb5441aa25180c2c78e2ee97" alt="" width="2026" height="1222" data-path="images/12f8357f-image.jpeg" />
</Frame>

### Address page example

<Frame>
  <img src="https://mintcdn.com/blockscout/GHvuDaE4gRKuNH6O/images/daaf31ba-image.jpeg?fit=max&auto=format&n=GHvuDaE4gRKuNH6O&q=85&s=84edcd23b348f98364001bb6733dcbb5" alt="" width="2304" height="1333" data-path="images/daaf31ba-image.jpeg" />
</Frame>
