...
````yaml /openapi-specs/Master-pro-api.json get /{chain_id}/api/v2/tokens/{address_hash_param}/instances/{token_id_param}/transfers
openapi: 3.0.0
info:
  contact:
...
paths:
  /{chain_id}/api/v2/tokens/{address_hash_param}/instances/{token_id_param}/transfers:
    get:
      ...
      description: >-
        Retrieves token transfers for a specific token instance (by token
