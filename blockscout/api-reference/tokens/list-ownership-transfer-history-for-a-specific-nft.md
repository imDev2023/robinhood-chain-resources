...
````yaml /openapi-specs/Master-pro-api.json get /{chain_id}/api/v2/tokens/{address_hash_param}/transfers
openapi: 3.0.0
info:
  contact:
...
paths:
  /{chain_id}/api/v2/tokens/{address_hash_param}/transfers:
    get:
      ...
      description: >-
        Retrieves transfer history for a specific NFT instance, showing
