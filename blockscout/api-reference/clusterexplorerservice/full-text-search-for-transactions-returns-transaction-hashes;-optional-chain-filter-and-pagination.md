...
````yaml /openapi-specs/Master-pro-api.json get /services/multichain/api/v1/clusters/{cluster_id}/search/transactions
openapi: 3.0.0
info:
  contact:
...
paths:
  /services/multichain/api/v1/clusters/{cluster_id}/search/transactions:
    get:
      ...
      summary: >-
        Full-text search for transactions (returns transaction hashes); optional
        chain filter and pagination.
