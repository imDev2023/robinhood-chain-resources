...
````yaml /openapi-specs/Master-pro-api.json get /services/multichain/api/v1/clusters/{cluster_id}/search/blocks
openapi: 3.0.0
info:
  contact:
...
paths:
  /services/multichain/api/v1/clusters/{cluster_id}/search/blocks:
    get:
      ...
      summary: >-
        Full-text search for blocks (returns block hashes); optional chain
