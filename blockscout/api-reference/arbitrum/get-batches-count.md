...
````yaml /openapi-specs/Master-pro-api.json get /{chain_id}/api/v2/arbitrum/batches/count
openapi: 3.0.0
info:
  contact:
...
paths:
  /{chain_id}/api/v2/arbitrum/batches/count:
    get:
      ...
      description: >-
        Retrieves the total count of Arbitrum batches committed to the Parent
        chain.
