...
````yaml /openapi-specs/Master-pro-api.json get /{chain_id}/api/v2/main-page/arbitrum/batches/latest-number
openapi: 3.0.0
info:
  contact:
...
paths:
  /{chain_id}/api/v2/main-page/arbitrum/batches/latest-number:
    get:
      ...
      description: >-
        Retrieves the number of the most recent Arbitrum batch submitted to the
        Parent chain. Returns 0 if no batches exist.
