...
````yaml /openapi-specs/Master-pro-api.json get /{chain_id}/api/v2/arbitrum/messages/{direction}/count
openapi: 3.0.0
info:
  contact:
...
paths:
  /{chain_id}/api/v2/arbitrum/messages/{direction}/count:
    get:
      ...
      description: >-
        Retrieves the total count of Arbitrum cross-chain messages for the
        specified direction.
