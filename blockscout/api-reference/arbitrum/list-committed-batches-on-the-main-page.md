...
````yaml /openapi-specs/Master-pro-api.json get /{chain_id}/api/v2/main-page/arbitrum/batches/committed
openapi: 3.0.0
info:
  contact:
...
paths:
  /{chain_id}/api/v2/main-page/arbitrum/batches/committed:
    get:
      ...
      description: >-
        Retrieves a list of Arbitrum batches that have been committed to the
        Parent chain, displayed on the main page.
