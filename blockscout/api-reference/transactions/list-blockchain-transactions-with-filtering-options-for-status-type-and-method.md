...
````yaml /openapi-specs/Master-pro-api.json get /{chain_id}/api/v2/transactions
openapi: 3.0.0
info:
  contact:
  ...
  /{chain_id}/api/v2/transactions:
    get:
      tags:
        - transactions
      summary: >-
        List blockchain transactions with filtering options for status, type,
        and method
      description: >-
        Retrieves a paginated list of transactions with optional filtering by
        status, type, and method.
