...
````yaml /openapi-specs/Master-pro-api.json get /{chain_id}/api/v2/transactions/{transaction_hash_param}
openapi: 3.0.0
info:
  contact:
...
paths:
  /{chain_id}/api/v2/transactions/{transaction_hash_param}:
    get:
      ...
      description: >-
        Retrieves detailed information for a specific transaction identified by
        its hash.
