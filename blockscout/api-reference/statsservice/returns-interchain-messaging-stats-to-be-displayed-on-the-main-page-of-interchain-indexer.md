...
````yaml /openapi-specs/Master-pro-api.json get /{chain_id}/stats-service/api/v1/pages/interchain/main
openapi: 3.0.0
info:
  contact:
  ...
  /{chain_id}/stats-service/api/v1/pages/interchain/main:
    get:
      tags:
        - StatsService
      summary: >-
        Returns interchain messaging stats to be displayed on the main page of
        interchain indexer.
