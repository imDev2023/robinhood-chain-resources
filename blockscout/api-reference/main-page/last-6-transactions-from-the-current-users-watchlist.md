...
````yaml /openapi-specs/Master-pro-api.json get /{chain_id}/api/v2/main-page/transactions/watchlist
openapi: 3.0.0
info:
  contact:
...
paths:
  /{chain_id}/api/v2/main-page/transactions/watchlist:
    get:
      ...
      description: >-
        Retrieves a list of last 6 transactions from the current user's
        watchlist.
