...
````yaml /openapi-specs/Master-pro-api.json get /{chain_id}/api/v2/stats/charts/transactions
openapi: 3.0.0
info:
  contact:
...
paths:
  /{chain_id}/api/v2/stats/charts/transactions:
    get:
      ...
      description: >-
        Retrieves time series data of daily transaction counts for rendering
        charts.
