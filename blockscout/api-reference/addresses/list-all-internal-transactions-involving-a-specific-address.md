...
````yaml /openapi-specs/Master-pro-api.json get /{chain_id}/api/v2/addresses/{address_hash_param}/internal-transactions
openapi: 3.0.0
info:
  contact:
...
paths:
  /{chain_id}/api/v2/addresses/{address_hash_param}/internal-transactions:
    get:
      ...
      description: >-
        Retrieves all internal transactions involving a specific address, with
        optional filtering for internal transactions sent from or to the
        address.
