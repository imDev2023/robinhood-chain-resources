...
````yaml /openapi-specs/Master-pro-api.json get /{chain_id}/api/v2/addresses/{address_hash_param}/token-balances
openapi: 3.0.0
info:
  contact:
...
paths:
  /{chain_id}/api/v2/addresses/{address_hash_param}/token-balances:
    get:
      ...
      description: >-
        Retrieves all token balances held by a specific address, including
        ERC-20, ERC-721, ERC-1155, and ERC-404 tokens.
