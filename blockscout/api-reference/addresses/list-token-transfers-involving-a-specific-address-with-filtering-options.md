...
````yaml /openapi-specs/Master-pro-api.json get /{chain_id}/api/v2/addresses/{address_hash_param}/token-transfers
openapi: 3.0.0
info:
  contact:
...
paths:
  /{chain_id}/api/v2/addresses/{address_hash_param}/token-transfers:
    get:
      ...
      description: >-
        Retrieves token transfers involving a specific address, with optional
        filtering by token type, direction, and specific token.
