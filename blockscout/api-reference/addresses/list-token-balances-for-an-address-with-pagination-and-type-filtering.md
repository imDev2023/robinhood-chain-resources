...
````yaml /openapi-specs/Master-pro-api.json get /{chain_id}/api/v2/addresses/{address_hash_param}/tokens
openapi: 3.0.0
info:
  contact:
...
paths:
  /{chain_id}/api/v2/addresses/{address_hash_param}/tokens:
    get:
      ...
      description: >-
        Retrieves token balances for a specific address with pagination and
        filtering by token type. Useful for displaying large token portfolios.
