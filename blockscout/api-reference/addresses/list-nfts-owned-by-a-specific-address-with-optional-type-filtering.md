...
````yaml /openapi-specs/Master-pro-api.json get /{chain_id}/api/v2/addresses/{address_hash_param}/nft
openapi: 3.0.0
info:
  contact:
...
paths:
  /{chain_id}/api/v2/addresses/{address_hash_param}/nft:
    get:
      ...
      description: >-
        Retrieves a list of NFTs (non-fungible tokens) owned by a specific
        address, with optional filtering by token type.
