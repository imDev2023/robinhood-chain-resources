...
````yaml /openapi-specs/Master-pro-api.json get /{chain_id}/api/v2/addresses/{address_hash_param}/transactions
openapi: 3.0.0
info:
  contact:
...
paths:
  /{chain_id}/api/v2/addresses/{address_hash_param}/transactions:
    get:
      ...
      description: >-
        Retrieves transactions involving a specific address, with optional
        filtering for transactions sent from or to the address.
                ...
                properties:
                  ...
                  next_page_params:
                    ...
                    example:
                      ...
                      fee: '19206937428000'
                      hash: >-
                        0xe38d616dade747097354b0731b5560f581536dacf22121feb4bb4a0b776018aa
                      index: 103
