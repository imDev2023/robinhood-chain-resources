...
````yaml /openapi-specs/Master-pro-api.json get /{chain_id}/api/v2/proxy/account-abstraction/operations/{operation_hash_param}/summary
openapi: 3.0.0
info:
  contact:
...
paths:
  /{chain_id}/api/v2/proxy/account-abstraction/operations/{operation_hash_param}/summary:
    get:
      ...
      description: >-
        Retrieves a human-readable summary of what a user operation did,
