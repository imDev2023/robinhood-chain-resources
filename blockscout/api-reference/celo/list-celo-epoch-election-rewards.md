...
````yaml /openapi-specs/Master-pro-api.json get /{chain_id}/api/v2/celo/epochs/{number}/election-rewards/{type}
openapi: 3.0.0
info:
  contact:
...
paths:
  /{chain_id}/api/v2/celo/epochs/{number}/election-rewards/{type}:
    get:
      ...
      description: >-
        Retrieves a paginated list of election rewards for a Celo epoch and
        reward type.
