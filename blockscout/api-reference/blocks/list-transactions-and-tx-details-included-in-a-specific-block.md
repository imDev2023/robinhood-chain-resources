...
````yaml /openapi-specs/Master-pro-api.json get /{chain_id}/api/v2/blocks/{block_hash_or_number_param}/transactions
openapi: 3.0.0
info:
  contact:
...
paths:
  /{chain_id}/api/v2/blocks/{block_hash_or_number_param}/transactions:
    get:
      ...
      description: >-
        Retrieves transactions included in a specific block, ordered by
        transaction index.
