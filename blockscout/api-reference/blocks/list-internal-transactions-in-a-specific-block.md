...
````yaml /openapi-specs/Master-pro-api.json get /{chain_id}/api/v2/blocks/{block_hash_or_number_param}/internal-transactions
openapi: 3.0.0
info:
  contact:
...
paths:
  /{chain_id}/api/v2/blocks/{block_hash_or_number_param}/internal-transactions:
    get:
      ...
      description: >-
        Retrieves internal transactions included in a specific block with
        optional filtering by type and call type.
