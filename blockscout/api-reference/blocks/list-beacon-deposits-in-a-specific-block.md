...
````yaml /openapi-specs/Master-pro-api.json get /{chain_id}/api/v2/blocks/{block_hash_or_number_param}/beacon/deposits
openapi: 3.0.0
info:
  contact:
...
paths:
  /{chain_id}/api/v2/blocks/{block_hash_or_number_param}/beacon/deposits:
    get:
      ...
      description: >-
        Retrieves beacon deposits included in a specific block with pagination
        support.
