...
````yaml /openapi-specs/Master-pro-api.json get /{chain_id}/api/v2/withdrawals
openapi: 3.0.0
info:
  contact:
...
paths:
  /{chain_id}/api/v2/withdrawals:
    get:
      ...
      description: >-
        Retrieves a paginated list of withdrawals, typically for proof-of-stake
        networks supporting validator withdrawals.
