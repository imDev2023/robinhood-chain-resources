...
# Deploy Blockscout on Rollup Chains

> Deploy Blockscout as an L2 rollup explorer with environment variables and settings for Optimism, Arbitrum, zkSync, and other supported rollup stacks.

<Tip>
  🚗 [Autoscout is now available](/using-blockscout/autoscout), providing a simple one-click rollup explorer deployment with Blockscout's optimized hosting infrastructure. Use it for early testing, modifications, and launching a full production-grade explorer. [Get Started Now](/using-blockscout/autoscout) and have **your rollup explorer up-and-running in minutes.**
</Tip>

Follow the general [docker](/setup/deployment/docker-compose-deployment) or [manual](/setup/deployment/manual-deployment-guide) instructions for deployment and include additional ENVs (starting with `CHAIN_TYPE`) as rollup deployments require different backend setups depending on the rollup type. Below we provide information and examples for [Arbitrum](/setup/deployment/rollup-deployment#arbitrum) and [Optimism](/setup/deployment/rollup-deployment#optimism).
...
<Frame caption>
  <img src="https://mintcdn.com/blockscout/GHvuDaE4gRKuNH6O/images/f5b77e66-image.jpeg?fit=max&auto=format&n=GHvuDaE4gRKuNH6O&q=85&s=0b46af653cfc608360b666e0ed6011bb" alt="" width="2304" height="952" data-path="images/f5b77e66-image.jpeg" />
</Frame>

#### `INDEXER_ARBITRUM_L1_ROLLUP_INIT_BLOCK`

<Tip>
  You can also use the [Blockscout MCP](/devs/mcp-server) to find values for the `ROLLUP_INIT_BLOCK` and `RPC_HISTORICAL_BLOCKS_RANGE`. [See this example.](/devs/mcp-examples/rollup-deployment-variables)
</Tip>
...
<Frame caption>
  <img src="https://mintcdn.com/blockscout/5j9ATJZuQuk5LMJq/images/3cb03a01-image.jpeg?fit=max&auto=format&n=5j9ATJZuQuk5LMJq&q=85&s=cff4a5ef151a670750d4c5ab943f0fec" alt="" width="1982" height="1018" data-path="images/3cb03a01-image.jpeg" />
</Frame>

<Frame caption>
  <img src="https://mintcdn.com/blockscout/kl-dO7vK6d_hNvHA/images/c2970836-image.jpeg?fit=max&auto=format&n=kl-dO7vK6d_hNvHA&q=85&s=0c9899b4bbedb463073c7a5b299b693c" alt="" width="1750" height="1216" data-path="images/c2970836-image.jpeg" />
</Frame>
...
3. Batch production rate for the rollup. To check this you will look at the `SequencerInbox` contract. To find the contract address, go to the `Rollup` contract in the block explorer, go to read methods (or read proxy), and find the `SequencerInbox` method. This will display the address of the contract.

<Frame caption="Click contract and Read Contract (or read proxy depending on the contract type)">
  <img src="https://mintcdn.com/blockscout/9uuzTGHWzjbW9Lu3/images/777f1bae-image.jpeg?fit=max&auto=format&n=9uuzTGHWzjbW9Lu3&q=85&s=64deffd58598184038ace1b7d757ee4a" alt="" width="1948" height="1202" data-path="images/777f1bae-image.jpeg" />
</Frame>

<Frame caption="Scroll to the sequencerInbox method and copy the contract address">
  <img src="https://mintcdn.com/blockscout/5j9ATJZuQuk5LMJq/images/5126072e-image.jpeg?fit=max&auto=format&n=5j9ATJZuQuk5LMJq&q=85&s=2dfd4c894ac159c11e724e13f4842bcb" alt="" width="1440" height="1254" data-path="images/5126072e-image.jpeg" />
</Frame>
...
<Frame caption>
  <img src="https://mintcdn.com/blockscout/BBa8nQTQ6isU0DUJ/images/9ea266f9-image.jpeg?fit=max&auto=format&n=BBa8nQTQ6isU0DUJ&q=85&s=2fac157d24fec1a62325e05e06a53a73" alt="" width="1630" height="1328" data-path="images/9ea266f9-image.jpeg" />
</Frame>
