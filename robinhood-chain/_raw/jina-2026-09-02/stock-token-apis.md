Title: Stock Token APIs

URL Source: https://docs.robinhood.com/chain/stock-token-apis
...
[Ask in ChatGPT](https://chatgpt.com/?hints=search&q=Please%20research%20and%20analyze%20this%20page%3A%20https%3A%2F%2Fdocs.robinhood.com%2Fchain%2Fstock-token-apis%20so%20I%20can%20ask%20you%20questions%20about%20it.%20Once%20you%20have%20read%20it%2C%20prompt%20me%20with%20any%20questions%20I%20have.%20Do%20not%20post%20content%20from%20the%20page%20in%20your%20response.%20Any%20of%20my%20follow%20up%20questions%20must%20reference%20the%20site%20I%20gave%20you.)

## On this page

*   [/assets](https://docs.robinhood.com/chain/stock-token-apis#assets)

    *   [Schema](https://docs.robinhood.com/chain/stock-token-apis#schema)
    *   [Example](https://docs.robinhood.com/chain/stock-token-apis#example)

*   [/prices](https://docs.robinhood.com/chain/stock-token-apis#prices)

    *   [Schema](https://docs.robinhood.com/chain/stock-token-apis#schema-1)
    *   [Example](https://docs.robinhood.com/chain/stock-token-apis#example-1)

*   [/corporate-actions](https://docs.robinhood.com/chain/stock-token-apis#corporate-actions)

    *   [Schema](https://docs.robinhood.com/chain/stock-token-apis#schema-2)
    *   [Example](https://docs.robinhood.com/chain/stock-token-apis#example-2)

*   [Next steps](https://docs.robinhood.com/chain/stock-token-apis#next-steps)

# Stock Token APIs[](https://docs.robinhood.com/chain/stock-token-apis#stock-token-apis)
...
#### AssetStatus[](https://docs.robinhood.com/chain/stock-token-apis#assetstatus)
...
#### tradingCapabilities[](https://docs.robinhood.com/chain/stock-token-apis#tradingcapabilities)
...
#### CorporateActionType[](https://docs.robinhood.com/chain/stock-token-apis#corporateactiontype)
...
#### CorporateActionStatus[](https://docs.robinhood.com/chain/stock-token-apis#corporateactionstatus)
...
#### Details variants[](https://docs.robinhood.com/chain/stock-token-apis#details-variants)
...
[Building with Stock Tokens Previous shift←](https://docs.robinhood.com/chain/building-with-stock-tokens)[Differences from Ethereum Next shift→](https://docs.robinhood.com/chain/differences-from-ethereum)
