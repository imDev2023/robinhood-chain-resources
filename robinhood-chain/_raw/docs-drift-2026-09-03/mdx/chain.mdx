...
<CardGrid columns={3}>
    <Card
        icon={<Icon name="rhw_browser_tab" />}
        title="Connect to the network"
        href="/chain/connecting"
    >
        Learn how to connect to Robinhood Chain
    </Card>
    <Card
        icon={<Icon name="documents" />}
        title="Deploy a smart contract"
        href="/chain/deploy-smart-contracts"
    >
        Get your first contract live on Robinhood Chain using Foundry or Hardhat
    </Card>
    <Card
        icon={<Icon name="crypto" />}
        title="Run a full node"
        href="/chain/run-a-full-node"
    >
        Spin up your own Robinhood Chain node for full data access and independence
    </Card>
</CardGrid>
