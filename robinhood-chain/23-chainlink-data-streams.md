...
> Content-diffed 2026-09-03 against the native-markdown route `<url>.md`. **One material addition:** the Getting started list now also points at the Discovery endpoint for enumerating streams programmatically. Applied below; the rest of the page is unchanged.
...
## [How to use Data Streams](#how-to-use-data-streams)
