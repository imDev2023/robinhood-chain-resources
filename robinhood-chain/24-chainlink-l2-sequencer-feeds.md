...
> Replaces the 2026-08-12 Tavily extract, which mangled the example consumer contract beyond use: identifiers were stripped, leaving `import{} from`, `AggregatorV2V3Interface internal;` and `uint256 private constant = 3600;`. The code below is the source's own.
> **Material change since 2026-08-12: Chainlink added a CAUTION availability notice stating it is no longer expanding L2 Sequencer Uptime Feeds to additional networks.** See `CHANGELOG-2026-09-02.md`.
> Robinhood Chain is **not** among the eleven supported networks listed on this page, on either the 2026-08-12 or the 2026-09-03 capture.

---

# L2 Sequencer Uptime Feeds

> **CAUTION: Availability notice**
>
