<!-- source: https://developers.uniswap.org/docs/sdks/v2/guides/fetching-data | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/sdks/v2/guides/fetching-data.md (native markdown) -->
# Fetching Data (/docs/sdks/v2/guides/fetching-data)

Fetch token and pair state with the Uniswap v2 SDK using reliable onchain data sources.

While the SDK is fully self-contained, there are two cases where it needs *onchain data* to function.
