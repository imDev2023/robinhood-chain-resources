<!-- source: https://developers.uniswap.org/docs/sdks/v2/guides/swapping | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/sdks/v2/guides/swapping.md (native markdown) -->
# Trading (/docs/sdks/v2/guides/swapping)

Build swap transaction parameters with the Uniswap v2 SDK and submit them with your signer.
