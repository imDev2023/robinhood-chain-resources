<!-- source: https://developers.uniswap.org/docs/sdks/v4/guides/swapping/multi-hop-swapping | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/sdks/v4/guides/swapping/multi-hop-swapping.md (native markdown) -->
# Executing Multi-Hop Swaps (/docs/sdks/v4/guides/swapping/multi-hop-swapping)

Execute multi-hop swaps on Uniswap v4 with SDK path encoding and router calldata.
