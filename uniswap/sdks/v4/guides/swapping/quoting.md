<!-- source: https://developers.uniswap.org/docs/sdks/v4/guides/swapping/quoting | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/sdks/v4/guides/swapping/quoting.md (native markdown) -->
# Getting a Quote (/docs/sdks/v4/guides/swapping/quoting)

Get Uniswap v4 swap quotes with Quoter simulations before submitting swap transactions.
...
We get the `QUOTER_CONTRACT_ADDRESS` for our chain from [Uniswap Deployments](/docs/protocols/v4/deployments).
