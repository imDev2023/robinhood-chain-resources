<!-- source: https://developers.uniswap.org/docs/sdks/v4/guides/swapping/single-hop-swapping | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/sdks/v4/guides/swapping/single-hop-swapping.md (native markdown) -->
# Executing a Single-Hop Swap (/docs/sdks/v4/guides/swapping/single-hop-swapping)

Execute single-hop swaps on Uniswap v4 with SDK route parameters and router calldata.
