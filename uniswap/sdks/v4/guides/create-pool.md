<!-- source: https://developers.uniswap.org/docs/sdks/v4/guides/create-pool | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/sdks/v4/guides/create-pool.md (native markdown) -->
# Create Pool (/docs/sdks/v4/guides/create-pool)

Create and initialize a Uniswap v4 pool using SDK utilities and pool key configuration.
