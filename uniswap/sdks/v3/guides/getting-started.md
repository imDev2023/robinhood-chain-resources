<!-- source: https://developers.uniswap.org/docs/sdks/v3/guides/getting-started | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/sdks/v3/guides/getting-started.md (native markdown) -->
# Get Started (/docs/sdks/v3/guides/getting-started)

Set up a local mainnet-fork workflow for the Uniswap v3 SDK using Foundry and Anvil.
...
<img alt="anvil result after calling" src={__img0} placeholder="blur" />
...
<img alt="anvil result after calling" src={__img1} placeholder="blur" />
...
Check out one of the [guides about swapping](/docs/sdks/v3/guides/swapping/swapping) and replace the RPC URL with your local anvil HTTP link as above.

## Where to Go Next
* Build route quotes in [Swapping Guides](/docs/sdks/v3/guides/swapping/quoting)
* Continue with [Managing Liquidity Getting Started](/docs/sdks/v3/guides/managing-liquidity/getting-started)
* Read pool snapshots in [Fetching Pool Data](/docs/sdks/v3/guides/pool-data)
* Learn oracle math in [Uniswap as a Price Oracle](/docs/sdks/v3/guides/price-oracle)
