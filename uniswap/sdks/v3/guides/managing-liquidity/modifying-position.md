<!-- source: https://developers.uniswap.org/docs/sdks/v3/guides/managing-liquidity/modifying-position | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/sdks/v3/guides/managing-liquidity/modifying-position.md (native markdown) -->
# Adding & Removing Liquidity (/docs/sdks/v3/guides/managing-liquidity/modifying-position)

Modify Uniswap v3 liquidity positions with SDK helpers for increase and decrease operations.
...
> [!NOTE]
> This guide assumes you are familiar with our [Minting a Position](/docs/sdks/v3/guides/managing-liquidity/position-minting) guide. A minted position is required to add or remove liquidity from, so the buttons will be disabled until a position is minted.
> 
...
We demonstrated how to do that in the [first guide](/docs/sdks/v3/guides/managing-liquidity/getting-started#fetching-positions) of this series.
...
The tokenId can be fetched with the tokenOfOwnerByIndex function of the NonfungiblePositionManager Contract as described [here](/docs/sdks/v3/guides/managing-liquidity/getting-started#fetching-positions).
...
## Where to Go Next
Now that you can mint and modify a position, check out how to [collect fees](/docs/sdks/v3/guides/managing-liquidity/collect-fees) from the position!
