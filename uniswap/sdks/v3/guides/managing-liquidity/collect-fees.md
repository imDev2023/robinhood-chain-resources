<!-- source: https://developers.uniswap.org/docs/sdks/v3/guides/managing-liquidity/collect-fees | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/sdks/v3/guides/managing-liquidity/collect-fees.md (native markdown) -->
# Collecting Fees (/docs/sdks/v3/guides/managing-liquidity/collect-fees)

Collect accrued fees from Uniswap v3 positions using SDK-generated calldata and options.
...
Read more about fetching position info [here](/docs/sdks/v3/guides/managing-liquidity/getting-started#fetching-positions).
...
We fetch the position info like in this code snippet taken from the [Fetching Positions guide](/docs/sdks/v3/guides/managing-liquidity/position-fetching):
