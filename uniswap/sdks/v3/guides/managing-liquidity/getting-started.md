<!-- source: https://developers.uniswap.org/docs/sdks/v3/guides/managing-liquidity/getting-started | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/sdks/v3/guides/managing-liquidity/getting-started.md (native markdown) -->
# Understanding Liquidity Positions (/docs/sdks/v3/guides/managing-liquidity/getting-started)

Understand Uniswap v3 positions and set up the SDK workflow for liquidity management tasks.
...
Take a look at the [Modify Positions guide](modifying-position) to learn how to create the `currentPosition` and `removeLiquidityOptions` parameters.
