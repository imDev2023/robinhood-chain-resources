<!-- source: https://developers.uniswap.org/docs/sdks/v3/guides/managing-liquidity/swap-and-add | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/sdks/v3/guides/managing-liquidity/swap-and-add.md (native markdown) -->
# Swapping and Adding Liquidity (/docs/sdks/v3/guides/managing-liquidity/swap-and-add)

Combine swaps and liquidity adds with the Uniswap v3 SDK to rebalance position funding.
...
We described the `getTokenTransferApproval` function [here](/docs/sdks/v3/guides/managing-liquidity/position-minting#giving-approval-to-transfer-our-tokens).
...
For a more detailed example, check out our [routing guide](/docs/sdks/v3/guides/swapping/routing).
