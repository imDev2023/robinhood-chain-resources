<!-- source: https://developers.uniswap.org/docs/sdks/v3/guides/managing-liquidity/position-minting | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/sdks/v3/guides/managing-liquidity/position-minting.md (native markdown) -->
# Minting a Position (/docs/sdks/v3/guides/managing-liquidity/position-minting)

Mint a concentrated liquidity position with the Uniswap v3 SDK and position manager calldata.
...
Then, we get the Pool's data by creating a reference to the Pool's smart contract and accessing its methods, very similar to what we did in the [Quoting guide](/docs/sdks/v3/guides/swapping/quoting#referencing-the-pool-contract-and-fetching-metadata):
...
You can find an example of that in the [Range Order guide](/docs/sdks/v3/guides/managing-liquidity/range-orders).
...
## Where to Go Next
Once you have minted a position, our next guide [Adding and Removing Liquidity](/docs/sdks/v3/guides/managing-liquidity/modifying-position) will demonstrate how you can add and remove liquidity from that minted position!
