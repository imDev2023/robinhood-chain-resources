<!-- source: https://developers.uniswap.org/docs/sdks/v3/guides/swapping/routing | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/sdks/v3/guides/swapping/routing.md (native markdown) -->
# Routing a Swap (/docs/sdks/v3/guides/swapping/routing)

Build token routing paths with the Uniswap v3 SDK for efficient multi-pool swaps.
...
We can get the **V3\_SWAP\_ROUTER\_ADDRESS** for our chain from the `SwapRouter02` field in [Deployments](/docs/protocols/v3/deployments).
