<!-- source: https://developers.uniswap.org/docs/sdks/v3/guides/pool-data | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/sdks/v3/guides/pool-data.md (native markdown) -->
# Fetching Pool Data (/docs/sdks/v3/guides/pool-data)

Fetch and model Uniswap v3 pool state with the SDK for pricing and liquidity workflows.
...
At the end of the guide, we will have created a `Pool` Object that accurately represents the state of a Uniswap v3 pool at the time we fetched it.
...
## Fetching All Ticks
v3 pools use ticks to [concentrate liquidity](/docs/get-started/concepts/liquidity-providers/concentrated-liquidity) in price ranges and allow for better pricing of trades.
...
If you are not familiar with the concept of ticks, check out the concept guide on [`concentrated liquidity`](/docs/get-started/concepts/liquidity-providers/concentrated-liquidity#ticks).
...
<img alt="TickBitmap" src={__img0} placeholder="blur" />
...
## Where to Go Next
Now that you are familiar with fetching Pool data, continue your journey with the [next example](/docs/sdks/v3/guides/managing-liquidity/active-liquidity) on visualizing the Liquidity density of a pool.
