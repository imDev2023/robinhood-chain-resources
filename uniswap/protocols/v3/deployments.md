<!-- source: https://developers.uniswap.org/docs/protocols/v3/deployments | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v3/deployments.md (native markdown) -->
# Deployments (/docs/protocols/v3/deployments)
