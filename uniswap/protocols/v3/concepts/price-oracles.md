<!-- source: https://developers.uniswap.org/docs/protocols/v3/concepts/price-oracles | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v3/concepts/price-oracles.md (native markdown) -->
# Price Oracles (/docs/protocols/v3/concepts/price-oracles)

Understand how Uniswap v3 pools serve as onchain price oracles with historical price and liquidity data.
...
All Uniswap v3 pools can serve as oracles, offering access to historical price and liquidity data. This capability unlocks a wide range of onchain use cases.
