<!-- source: https://developers.uniswap.org/docs/protocols/v3/guides/managing-liquidity/mint-a-position | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v3/guides/managing-liquidity/mint-a-position.md (native markdown) -->
# Mint a New Position (/docs/protocols/v3/guides/managing-liquidity/mint-a-position)

Mint a new Uniswap v3 liquidity position with token approvals, ranges, and position parameters.
