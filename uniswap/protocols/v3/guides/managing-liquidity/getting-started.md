<!-- source: https://developers.uniswap.org/docs/protocols/v3/guides/managing-liquidity/getting-started | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v3/guides/managing-liquidity/getting-started.md (native markdown) -->
# Set Up Your Contract (/docs/protocols/v3/guides/managing-liquidity/getting-started)

Set up a Uniswap v3 liquidity management contract workflow with position lifecycle prerequisites.
