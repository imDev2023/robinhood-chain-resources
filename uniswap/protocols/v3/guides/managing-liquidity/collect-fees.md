<!-- source: https://developers.uniswap.org/docs/protocols/v3/guides/managing-liquidity/collect-fees | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v3/guides/managing-liquidity/collect-fees.md (native markdown) -->
# Collecting Fees (/docs/protocols/v3/guides/managing-liquidity/collect-fees)

Collect accrued fees from Uniswap v3 positions using NonfungiblePositionManager flows.
