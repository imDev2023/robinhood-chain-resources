<!-- source: https://developers.uniswap.org/docs/protocols/v3/guides/flash-swaps/getting-started | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v3/guides/flash-swaps/getting-started.md (native markdown) -->
# Get Started (/docs/protocols/v3/guides/flash-swaps/getting-started)

Set up a Uniswap v3 flash swap environment and prepare the contract workflow end to end.
