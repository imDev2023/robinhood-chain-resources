<!-- source: https://developers.uniswap.org/docs/protocols/v3/guides/flash-swaps/flash-callback | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v3/guides/flash-swaps/flash-callback.md (native markdown) -->
# The Flash Callback (/docs/protocols/v3/guides/flash-swaps/flash-callback)

Implement the Uniswap v3 flash callback to settle borrowed amounts and fees correctly.
