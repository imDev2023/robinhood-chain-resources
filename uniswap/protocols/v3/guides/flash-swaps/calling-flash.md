<!-- source: https://developers.uniswap.org/docs/protocols/v3/guides/flash-swaps/calling-flash | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v3/guides/flash-swaps/calling-flash.md (native markdown) -->
# Calling Flash (/docs/protocols/v3/guides/flash-swaps/calling-flash)

Call flash swap functions on Uniswap v3 and encode parameters for callback-driven execution.
