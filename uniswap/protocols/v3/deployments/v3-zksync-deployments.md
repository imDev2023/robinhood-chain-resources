<!-- source: https://developers.uniswap.org/docs/protocols/v3/deployments/v3-zksync-deployments | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v3/deployments/v3-zksync-deployments.md (native markdown) -->
# ZKsync Deployments (/docs/protocols/v3/deployments/v3-zksync-deployments)

Review Uniswap v3 deployment addresses and contract references for ZKsync integrations.
...
You can look up the address of an existing pool on [Uniswap Info](https://app.uniswap.org/explore) or by calling the `getPool` function on the `UniswapV3Factory` contract.
