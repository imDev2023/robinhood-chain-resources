<!-- source: https://developers.uniswap.org/docs/protocols/v3/deployments/v3-monad-deployments | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v3/deployments/v3-monad-deployments.md (native markdown) -->
# Monad Deployments (/docs/protocols/v3/deployments/v3-monad-deployments)

Review Uniswap v3 deployment addresses and contract references for Monad integrations.
