<!-- source: https://developers.uniswap.org/docs/protocols/v3/deployments/v3-world-chain-deployments | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v3/deployments/v3-world-chain-deployments.md (native markdown) -->
# World Chain Deployments (/docs/protocols/v3/deployments/v3-world-chain-deployments)

Review Uniswap v3 deployment addresses and contract references for World Chain integrations.
