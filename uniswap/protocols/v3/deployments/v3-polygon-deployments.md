<!-- source: https://developers.uniswap.org/docs/protocols/v3/deployments/v3-polygon-deployments | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v3/deployments/v3-polygon-deployments.md (native markdown) -->
# Polygon Deployments (/docs/protocols/v3/deployments/v3-polygon-deployments)

Uniswap v3 contract deployment addresses on Polygon.
...
> Polygon Mumbai testnet was deprecated in April 2024. For testing, developers should use Polygon Amoy testnet.
