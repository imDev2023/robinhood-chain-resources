<!-- source: https://developers.uniswap.org/docs/protocols/v3/deployments/v3-arbitrum-deployments | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v3/deployments/v3-arbitrum-deployments.md (native markdown) -->
# Arbitrum Deployments (/docs/protocols/v3/deployments/v3-arbitrum-deployments)

Review Uniswap v3 deployment addresses and contract references for Arbitrum integrations.
