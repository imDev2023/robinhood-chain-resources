<!-- source: https://developers.uniswap.org/docs/protocols/v3/deployments/v3-optimism-deployments | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v3/deployments/v3-optimism-deployments.md (native markdown) -->
# Optimism Deployments (/docs/protocols/v3/deployments/v3-optimism-deployments)

Review Uniswap v3 deployment addresses and contract references for Optimism integrations.
