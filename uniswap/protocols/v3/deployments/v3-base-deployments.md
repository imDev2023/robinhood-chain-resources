<!-- source: https://developers.uniswap.org/docs/protocols/v3/deployments/v3-base-deployments | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v3/deployments/v3-base-deployments.md (native markdown) -->
# Base Deployments (/docs/protocols/v3/deployments/v3-base-deployments)

Review Uniswap v3 deployment addresses and contract references for Base integrations.
