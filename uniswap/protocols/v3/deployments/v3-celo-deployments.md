<!-- source: https://developers.uniswap.org/docs/protocols/v3/deployments/v3-celo-deployments | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v3/deployments/v3-celo-deployments.md (native markdown) -->
# CELO Deployments (/docs/protocols/v3/deployments/v3-celo-deployments)

Review Uniswap v3 deployment addresses and contract references for Celo integrations.
