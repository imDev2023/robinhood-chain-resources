<!-- source: https://developers.uniswap.org/docs/protocols/v3/deployments/v3-bnb-deployments | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v3/deployments/v3-bnb-deployments.md (native markdown) -->
