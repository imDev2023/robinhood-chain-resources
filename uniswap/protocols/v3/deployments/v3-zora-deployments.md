<!-- source: https://developers.uniswap.org/docs/protocols/v3/deployments/v3-zora-deployments | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v3/deployments/v3-zora-deployments.md (native markdown) -->
# Zora Deployments (/docs/protocols/v3/deployments/v3-zora-deployments)

Uniswap v3 contract deployment addresses on Zora and Zora Sepolia.
