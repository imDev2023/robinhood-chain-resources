<!-- source: https://developers.uniswap.org/docs/protocols/v3/deployments/v3-avalanche-deployments | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v3/deployments/v3-avalanche-deployments.md (native markdown) -->
# Avalanche Deployments (/docs/protocols/v3/deployments/v3-avalanche-deployments)

Review Uniswap v3 deployment addresses and contract references for Avalanche integrations.
...
You can look up the address of an existing pool on [Uniswap Info](https://app.uniswap.org/explore#/) or by calling the [`getPool`](https://github.com/Uniswap/v3-core/blob/d8b1c635c275d2a9450bd6a78f3fa2484fef73eb/contracts/interfaces/IUniswapV3Factory.sol#L48) function on the `UniswapV3Factory` contract.
