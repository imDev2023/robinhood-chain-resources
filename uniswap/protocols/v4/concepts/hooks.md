<!-- source: https://developers.uniswap.org/docs/protocols/v4/concepts/hooks | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v4/concepts/hooks.md (native markdown) -->
