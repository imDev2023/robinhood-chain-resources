<!-- source: https://developers.uniswap.org/docs/protocols/v4/concepts/flash-accounting | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v4/concepts/flash-accounting.md (native markdown) -->
# Flash Accounting (/docs/protocols/v4/concepts/flash-accounting)

Understand flash accounting in Uniswap v4 and how deltas reduce transfer overhead.
...
With the singleton architecture, a better design was possible and is referred to as *Flash Accounting*. The design became practical with gas efficiencies of [Transient Storage](https://eips.ethereum.org/EIPS/eip-1153). *Flash Accounting* further reduces the gas cost of trades that cross multiple pools and supports more complex integrations with Uniswap v4.
...
<img alt="Flash Accounting Step 1" src={__img0} placeholder="blur" />
<img alt="Flash Accounting Step 2" src={__img1} placeholder="blur" />
...
1. `unlock` the `PoolManager`
   <img alt="Flash Accounting Locking Mechanism Step 1" src={__img2} placeholder="blur" />

2. Implement `unlockCallback` and proceed with any desired pool actions
   <img alt="Flash Accounting Locking Mechanism Step 2" src={__img3} placeholder="blur" />

3. The actual token transfer happens at the end and the *delta* should be resolved
   <img alt="Flash Accounting Locking Mechanism Step 3" src={__img4} placeholder="blur" />
...
## Swapping
<img alt="Multi-hop swaps on v3 vs v4" src={__img5} placeholder="blur" />
...
## Developer Resources
To see how unlock callbacks and deltas work in a smart contract, read [Unlock Callback and Deltas](/docs/protocols/v4/guides/unlock-callback-and-deltas).
