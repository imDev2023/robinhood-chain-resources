<!-- source: https://developers.uniswap.org/docs/protocols/v4/concepts/erc-6909 | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v4/concepts/erc-6909.md (native markdown) -->
# ERC-6909 (/docs/protocols/v4/concepts/erc-6909)

Learn how ERC-6909 supports efficient token accounting flows in Uniswap v4.
