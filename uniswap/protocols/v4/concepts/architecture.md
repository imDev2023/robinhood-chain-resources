<!-- source: https://developers.uniswap.org/docs/protocols/v4/concepts/architecture | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v4/concepts/architecture.md (native markdown) -->
# Architecture (/docs/protocols/v4/concepts/architecture)
