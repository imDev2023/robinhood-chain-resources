<!-- source: https://developers.uniswap.org/docs/protocols/v4/concepts/poolmanager | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v4/concepts/poolmanager.md (native markdown) -->
# PoolManager (/docs/protocols/v4/concepts/poolmanager)

Understand the Uniswap v4 PoolManager singleton architecture and its role in swaps and liquidity.
