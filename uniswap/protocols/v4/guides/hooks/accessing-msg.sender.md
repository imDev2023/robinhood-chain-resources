<!-- source: https://developers.uniswap.org/docs/protocols/v4/guides/hooks/accessing-msg.sender | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v4/guides/hooks/accessing-msg.sender.md (native markdown) -->
# Access msg.sender Inside a Hook (/docs/protocols/v4/guides/hooks/accessing-msg.sender)

Retrieve the original swap initiator inside a Uniswap v4 hook using trusted router patterns.
...
> [Refer to Building your first hook](/docs/protocols/v4/guides/hooks/getting-started)
...
* [https://github.com/Uniswap/universal-router/tree/main](https://github.com/Uniswap/universal-router/tree/main)
* [https://github.com/z0r0z/v4-router](https://github.com/z0r0z/v4-router)
