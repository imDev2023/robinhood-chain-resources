<!-- source: https://developers.uniswap.org/docs/protocols/v4/guides/hooks/async-swap | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v4/guides/hooks/async-swap.md (native markdown) -->
# AsyncSwap Hooks (/docs/protocols/v4/guides/hooks/async-swap)

Implement AsyncSwap-style hook behavior in Uniswap v4 using custom accounting and hook permissions.

One feature enabled by [custom accounting](/docs/protocols/v4/guides/custom-accounting) is AsyncSwap. This feature allows hook developers to replace v4 (v3-style) swap logic.
