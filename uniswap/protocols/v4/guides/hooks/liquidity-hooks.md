<!-- source: https://developers.uniswap.org/docs/protocols/v4/guides/hooks/liquidity-hooks | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v4/guides/hooks/liquidity-hooks.md (native markdown) -->
# Liquidity Hooks (/docs/protocols/v4/guides/hooks/liquidity-hooks)

Build Uniswap v4 liquidity hooks around add and remove liquidity lifecycle events.
