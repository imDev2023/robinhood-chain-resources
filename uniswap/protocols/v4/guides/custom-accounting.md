<!-- source: https://developers.uniswap.org/docs/protocols/v4/guides/custom-accounting | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v4/guides/custom-accounting.md (native markdown) -->
# Custom Accounting (/docs/protocols/v4/guides/custom-accounting)

Understand custom accounting patterns in Uniswap v4, including deltas, hook fees, and custom curves.
...
As described in [Flash Accounting](/docs/protocols/v4/concepts/flash-accounting), Uniswap v4 tracks net token transfers with transient storage. Unlike previous versions that tracked absolute token balances, v4 records changes to these balances (*deltas*). This approach is at the core of v4's enhanced flexibility and efficiency.
...
## Custom curves in v4
Custom Curves in Uniswap v4 represent a big change in AMM design flexibility. Unlike [Uniswap v2](/docs/protocols/v2/overview) where the x\*y=k formula was hardcoded, v4 allows developers to implement a wide variety of pricing models.
