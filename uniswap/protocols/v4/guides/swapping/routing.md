<!-- source: https://developers.uniswap.org/docs/protocols/v4/guides/swapping/routing | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v4/guides/swapping/routing.md (native markdown) -->
# Swap Routing (/docs/protocols/v4/guides/swapping/routing)

Configure Universal Router command encoding for Uniswap v4 swap routing flows.
...
This guide focuses on how to interact with Universal Router from an onchain contract.
...
Check the complete list of [commands](/docs/protocols/universal-router/concepts/commands).
