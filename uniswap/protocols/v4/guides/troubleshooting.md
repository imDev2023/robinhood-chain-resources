<!-- source: https://developers.uniswap.org/docs/protocols/v4/guides/troubleshooting | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v4/guides/troubleshooting.md (native markdown) -->
# Troubleshooting (v4) (/docs/protocols/v4/guides/troubleshooting)
...
## Core Manager and Hook Selectors
## IPoolManager.sol
...
## Fee, Position, and Reserve Selectors
## IProtocolFees.sol
| Error Selector                                      | Hex Value    |
| --------------------------------------------------- | ------------ |
