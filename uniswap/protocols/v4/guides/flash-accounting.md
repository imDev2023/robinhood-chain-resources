<!-- source: https://developers.uniswap.org/docs/protocols/v4/guides/flash-accounting | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v4/guides/flash-accounting.md (native markdown) -->
# Flash Accounting (/docs/protocols/v4/guides/flash-accounting)

Build with Uniswap v4 flash accounting by understanding deltas, settlement, and PoolManager flows.
