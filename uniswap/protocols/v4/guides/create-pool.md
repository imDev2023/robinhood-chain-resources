<!-- source: https://developers.uniswap.org/docs/protocols/v4/guides/create-pool | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v4/guides/create-pool.md (native markdown) -->
# Create Pool (/docs/protocols/v4/guides/create-pool)

Create a Uniswap v4 pool and optionally initialize it with liquidity in one flow.
...
## Guide: Encode Liquidity Operations
5. Encode the MINT_POSITION parameters [#5-encode-the-mint_position-parameters]
...
6. Encode the SETTLE_PAIR parameters [#6-encode-the-settle_pair-parameters]
...
## 7. Encode the modifyLiquidities call
```solidity
// Note: In production, deadlines should be calculated offchain using real time
