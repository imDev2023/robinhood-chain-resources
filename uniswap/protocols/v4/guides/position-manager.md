<!-- source: https://developers.uniswap.org/docs/protocols/v4/guides/position-manager | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v4/guides/position-manager.md (native markdown) -->
# Position Manager (/docs/protocols/v4/guides/position-manager)

Use the Uniswap v4 PositionManager command interface for advanced liquidity workflows.
...
CLOSE_CURRENCY: Handling unknown deltas [#close_currency-handling-unknown-deltas]
...
CLEAR_OR_TAKE: Optimizing for dust [#clear_or_take-optimizing-for-dust]
