<!-- source: https://developers.uniswap.org/docs/protocols/v4/guides/erc-6909 | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v4/guides/erc-6909.md (native markdown) -->
# ERC-6909 (/docs/protocols/v4/guides/erc-6909)

Use ERC-6909 primitives in Uniswap v4 to resolve deltas and manage balances efficiently.

## Introduction
Uniswap v4 uses [ERC-6909](/docs/protocols/v4/concepts/erc-6909), a token standard that works alongside the protocol's flash accounting system. This guide explains how ERC-6909 functions within v4, when to use mint versus burn operations, and how developers can implement them effectively.
