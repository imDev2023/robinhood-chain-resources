<!-- source: https://developers.uniswap.org/docs/protocols/protocol-fee/deployments | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/protocol-fee/deployments.md (native markdown) -->
# Deployments (/docs/protocols/protocol-fee/deployments)

Find Uniswap Protocol Fee deployment addresses and governance-controlled deployment flow details.
