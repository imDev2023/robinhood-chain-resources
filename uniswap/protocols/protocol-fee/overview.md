<!-- source: https://developers.uniswap.org/docs/protocols/protocol-fee/overview | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/protocol-fee/overview.md (native markdown) -->
