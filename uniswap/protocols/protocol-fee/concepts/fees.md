<!-- source: https://developers.uniswap.org/docs/protocols/protocol-fee/concepts/fees | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/protocol-fee/concepts/fees.md (native markdown) -->
# Protocol Fee Configuration (/docs/protocols/protocol-fee/concepts/fees)

Review protocol fee splits for Uniswap v2 and Uniswap v3 fee tiers in the current rollout.
