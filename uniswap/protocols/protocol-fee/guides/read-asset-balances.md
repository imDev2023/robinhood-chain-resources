<!-- source: https://developers.uniswap.org/docs/protocols/protocol-fee/guides/read-asset-balances | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/protocol-fee/guides/read-asset-balances.md (native markdown) -->
# Reading Asset Balances (/docs/protocols/protocol-fee/guides/read-asset-balances)

Read releasable asset balances across AssetSink, Uniswap v2 LP tokens, and Uniswap v3 pools.

As noted in [Best Practices](/docs/protocols/protocol-fee/guides/best-practices), the `AssetSink's` available asset balance is observed in three places:
