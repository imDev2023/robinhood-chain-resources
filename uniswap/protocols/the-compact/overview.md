<!-- source: https://developers.uniswap.org/docs/protocols/the-compact/overview | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/the-compact/overview.md (native markdown) -->
