<!-- source: https://developers.uniswap.org/docs/protocols/the-compact/concepts/resource-locks | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/the-compact/concepts/resource-locks.md (native markdown) -->
# Resource Locks (/docs/protocols/the-compact/concepts/resource-locks)

Learn how Uniswap The Compact resource locks encode allocator, scope, reset period, and token constraints.
