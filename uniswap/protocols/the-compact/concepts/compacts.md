<!-- source: https://developers.uniswap.org/docs/protocols/the-compact/concepts/compacts | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/the-compact/concepts/compacts.md (native markdown) -->
# Compacts & EIP-712 (/docs/protocols/the-compact/concepts/compacts)

Understand Uniswap The Compact agreement formats, witness data, and EIP-712 signing or registration workflows.
