<!-- source: https://developers.uniswap.org/docs/protocols/v4-hooks/dualpool/security | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v4-hooks/dualpool/security.md (native markdown) -->
# Security (/docs/protocols/v4-hooks/dualpool/security)
