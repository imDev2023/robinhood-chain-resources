<!-- source: https://developers.uniswap.org/docs/protocols/v2/guides/swapping | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v2/guides/swapping.md (native markdown) -->
# Implement a Swap (/docs/protocols/v2/guides/swapping)

Implement Uniswap v2 swaps from smart contracts using router functions and external price safety checks.
...
*Check out the [Pricing](/docs/protocols/v2/concepts/pricing#pricing-trades) page for a more in depth discussion on getting prices.*
...
The best way to protect against these attacks is to use an external price feed or "price oracle". The best "oracle" is simply *traders' offchain observation of the current price*, which can be passed into the trade as a safety check. This strategy is best for situations *where users initiate trades on their own behalf*.
