<!-- source: https://developers.uniswap.org/docs/protocols/v2/guides/getting-started | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v2/guides/getting-started.md (native markdown) -->
# Smart Contract Getting Started (/docs/protocols/v2/guides/getting-started)

Set up a Uniswap v2 smart contract development environment with Foundry, npm packages, and local testing.
