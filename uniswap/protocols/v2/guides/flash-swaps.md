<!-- source: https://developers.uniswap.org/docs/protocols/v2/guides/flash-swaps | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v2/guides/flash-swaps.md (native markdown) -->
# Flash Swaps (/docs/protocols/v2/guides/flash-swaps)

Implement Uniswap v2 flash swaps by handling callbacks, validating pair context, and repaying with required fees.
