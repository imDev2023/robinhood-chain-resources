<!-- source: https://developers.uniswap.org/docs/protocols/v2/guides/troubleshooting | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v2/guides/troubleshooting.md (native markdown) -->
# Troubleshooting (v2) (/docs/protocols/v2/guides/troubleshooting)

Diagnose common Uniswap v2 integration errors, including K, rebasing edge cases, and router transaction failures.
...
UniswapV2: TRANSFER_FAILED [#uniswapv2-transfer_failed]
