<!-- source: https://developers.uniswap.org/docs/protocols/v2/guides/getting-pair-addresses | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v2/guides/getting-pair-addresses.md (native markdown) -->
# Pair Addresses (/docs/protocols/v2/guides/getting-pair-addresses)
