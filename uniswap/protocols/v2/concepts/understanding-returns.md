<!-- source: https://developers.uniswap.org/docs/protocols/v2/concepts/understanding-returns | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v2/concepts/understanding-returns.md (native markdown) -->
# Understanding Returns (/docs/protocols/v2/concepts/understanding-returns)

Understand Uniswap v2 LP return drivers, including fee income, divergence loss, and market volatility effects.
