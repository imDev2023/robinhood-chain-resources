<!-- source: https://developers.uniswap.org/docs/protocols/v2/concepts/pools | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v2/concepts/pools.md (native markdown) -->
# Pools (/docs/protocols/v2/concepts/pools)

Understand Uniswap v2 pools, LP shares, and how reserve balances and fees affect liquidity outcomes.
