<!-- source: https://developers.uniswap.org/docs/protocols/v2/concepts/flash-swap | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v2/concepts/flash-swap.md (native markdown) -->
# Flash Swaps (/docs/protocols/v2/concepts/flash-swap)

Withdraw up to the full reserves of any ERC20 token on Uniswap v2 and execute arbitrary logic at no upfront cost.
