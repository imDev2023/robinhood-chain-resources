<!-- source: https://developers.uniswap.org/docs/protocols/v2/concepts/architecture | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v2/concepts/architecture.md (native markdown) -->
# Architecture (/docs/protocols/v2/concepts/architecture)

Understand Uniswap v2 core and periphery contracts and the design decisions behind pair behavior and routing.
