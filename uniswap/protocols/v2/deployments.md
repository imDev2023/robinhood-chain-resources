<!-- source: https://developers.uniswap.org/docs/protocols/v2/deployments | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/v2/deployments.md (native markdown) -->
# Deployments (/docs/protocols/v2/deployments)

Find Uniswap v2 factory and router deployment addresses across supported networks.

> [!NOTE]
> All Uniswap v2 deployment addresses are also available on the unified [Deployments](/deployments) page and its [deployments.json](/deployments.json) feed.
...
| X Layer         | `0xDf38F24fE153761634Be942F9d859f3DBA857E95` | `0x182a927119d56008d921126764bf884221b10f59` |
...
| Robinhood Chain | `0x8bceaa40b9acdfaedf85adf4ff01f5ad6517937f` | `0x89e5db8b5aa49aa85ac63f691524311aeb649eba` |
