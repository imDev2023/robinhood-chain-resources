<!-- source: https://developers.uniswap.org/docs/protocols/universal-router/concepts/commands | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/universal-router/concepts/commands.md (native markdown) -->
