<!-- source: https://developers.uniswap.org/docs/protocols/universal-router/overview | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/universal-router/overview.md (native markdown) -->
# Overview (/docs/protocols/universal-router/overview)
