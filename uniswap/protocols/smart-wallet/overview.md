<!-- source: https://developers.uniswap.org/docs/protocols/smart-wallet/overview | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/smart-wallet/overview.md (native markdown) -->
