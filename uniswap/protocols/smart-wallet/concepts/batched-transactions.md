<!-- source: https://developers.uniswap.org/docs/protocols/smart-wallet/concepts/batched-transactions | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/smart-wallet/concepts/batched-transactions.md (native markdown) -->
