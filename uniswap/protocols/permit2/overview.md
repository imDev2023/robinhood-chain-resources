<!-- source: https://developers.uniswap.org/docs/protocols/permit2/overview | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/protocols/permit2/overview.md (native markdown) -->
