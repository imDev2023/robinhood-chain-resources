<!-- source: https://developers.uniswap.org/docs/changelog/completed-notifications/proxy-approval | captured: 2026-09-02 | via: https://developers.uniswap.org/docs/changelog/completed-notifications/proxy-approval.md (native markdown) -->
# Proxy Approval (/docs/changelog/completed-notifications/proxy-approval)
