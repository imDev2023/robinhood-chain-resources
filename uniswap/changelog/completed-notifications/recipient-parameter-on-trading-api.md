<!-- source: https://developers.uniswap.org/docs/changelog/completed-notifications/recipient-parameter-on-trading-api | captured: 2026-09-02 | via: https://developers.uniswap.org/docs/changelog/completed-notifications/recipient-parameter-on-trading-api.md (native markdown) -->
# Custom Recipient on Trading API (/docs/changelog/completed-notifications/recipient-parameter-on-trading-api)
