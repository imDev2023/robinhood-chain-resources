<!-- source: https://developers.uniswap.org/docs/changelog/active-notifications/proxy-approval | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/changelog/active-notifications/proxy-approval.md (native markdown) -->
# Proxy Approval (/docs/changelog/active-notifications/proxy-approval)
