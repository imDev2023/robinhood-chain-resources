<!-- source: https://developers.uniswap.org/docs/changelog/active-notifications/uniswapx-rfq-auctions-on-base-and-arbitrum | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/changelog/active-notifications/uniswapx-rfq-auctions-on-base-and-arbitrum.md (native markdown) -->
# UniswapX RFQ Auctions on Base and Arbitrum (/docs/changelog/active-notifications/uniswapx-rfq-auctions-on-base-and-arbitrum)
