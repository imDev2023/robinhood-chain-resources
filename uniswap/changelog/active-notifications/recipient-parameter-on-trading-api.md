<!-- source: https://developers.uniswap.org/docs/changelog/active-notifications/recipient-parameter-on-trading-api | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/changelog/active-notifications/recipient-parameter-on-trading-api.md (native markdown) -->
# Custom Recipient on Trading API (/docs/changelog/active-notifications/recipient-parameter-on-trading-api)
