<!-- source: https://developers.uniswap.org/docs/ecosystem/subgraphs/concepts/v2/entities | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/ecosystem/subgraphs/concepts/v2/entities.md (native markdown) -->
# v2 Entities (/docs/ecosystem/subgraphs/concepts/v2/entities)

Schema reference for the Uniswap v2 subgraph entities and their fields.
