<!-- source: https://developers.uniswap.org/docs/ecosystem/subgraphs/guides/v4-query-examples | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/ecosystem/subgraphs/guides/v4-query-examples.md (native markdown) -->
# v4 Query Examples (/docs/ecosystem/subgraphs/guides/v4-query-examples)

Example GraphQL queries for fetching Uniswap v4 analytics data from the subgraph.
