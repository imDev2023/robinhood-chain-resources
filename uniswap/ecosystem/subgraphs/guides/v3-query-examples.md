<!-- source: https://developers.uniswap.org/docs/ecosystem/subgraphs/guides/v3-query-examples | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/ecosystem/subgraphs/guides/v3-query-examples.md (native markdown) -->
# v3 Query Examples (/docs/ecosystem/subgraphs/guides/v3-query-examples)

Example GraphQL queries for fetching Uniswap v3 analytics data from the subgraph.
