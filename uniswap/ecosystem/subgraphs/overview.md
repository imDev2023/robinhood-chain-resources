<!-- source: https://developers.uniswap.org/docs/ecosystem/subgraphs/overview | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/ecosystem/subgraphs/overview.md (native markdown) -->
# Subgraphs Overview (/docs/ecosystem/subgraphs/overview)
...
* GraphQL endpoint: `https://gateway.thegraph.com/api//subgraphs/id/DiYPVdygkfjDWhbxGSqAQxwBKmfKnkWQojqeM2rkLb3G`
...
* GraphQL endpoint: `https://gateway.thegraph.com/api//subgraphs/id/5zvR82QoaXYFyDEKLZ9t6v9adgnptxYpKpSbxtgVENFV`
...
* GraphQL endpoint: `https://gateway.thegraph.com/api//subgraphs/id/A3Np3RQbaBA6oKJgiwDJeo5T3zrYfGHPWFYayMwtNDum`
...
* GraphQL endpoint: `https://gateway.thegraph.com/api//subgraphs/id/ESnjgAG9NjfmHypk4Huu4PVvz55fUwpyrRqHF21thoLJ`
