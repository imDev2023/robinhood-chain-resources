<!-- source: https://developers.uniswap.org/docs/ecosystem/governance/overview | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/ecosystem/governance/overview.md (native markdown) -->
# Governance Overview (/docs/ecosystem/governance/overview)
...
## Where to Go Next
* Learn about supply, distribution, and the burn mechanism on the [UNI token](/docs/ecosystem/governance/uni) page.
