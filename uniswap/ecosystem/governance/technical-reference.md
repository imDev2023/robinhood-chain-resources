<!-- source: https://developers.uniswap.org/docs/ecosystem/governance/technical-reference | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/ecosystem/governance/technical-reference.md (native markdown) -->
# Technical Reference (/docs/ecosystem/governance/technical-reference)

Find Uniswap governance contracts, addresses, and ABI links for Ethereum mainnet and historical deployments.
