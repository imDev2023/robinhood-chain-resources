<!-- source: https://developers.uniswap.org/docs/ecosystem/governance/governance-process | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/ecosystem/governance/governance-process.md (native markdown) -->
# Governance Process (/docs/ecosystem/governance/governance-process)
...
<img alt="Proposal flow across the governance lifecycle" src={__img0} placeholder="blur" />
