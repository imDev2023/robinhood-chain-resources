<!-- source: https://developers.uniswap.org/docs/ecosystem/governance/guide-to-voting | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/ecosystem/governance/guide-to-voting.md (native markdown) -->
# Guide to Voting (/docs/ecosystem/governance/guide-to-voting)

Learn how to delegate UNI on Agora or Tally and vote on Uniswap governance proposals.
