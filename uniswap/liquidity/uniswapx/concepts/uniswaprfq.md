<!-- source: https://developers.uniswap.org/docs/liquidity/uniswapx/concepts/uniswaprfq | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/liquidity/uniswapx/concepts/uniswaprfq.md (native markdown) -->
# Request for Quote (RFQ) (/docs/liquidity/uniswapx/concepts/uniswaprfq)

Learn how UniswapX RFQ separates indicative and hard quotes to improve reliability on Ethereum swaps.
...
## V2 Flow
<img alt="V2 RFQ flow showing indicative and hard quote phases with cosigner finalization" src={__img0} placeholder="blur" />
...
<img alt="Diagram showing how the cosigner protects users from worst-case pricing within signed parameters" src={__img1} placeholder="blur" />
...
<img alt="V1 RFQ flow showing the pre-signature quoting process and its limitations" src={__img2} placeholder="blur" />
