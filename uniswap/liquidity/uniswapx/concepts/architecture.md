<!-- source: https://developers.uniswap.org/docs/liquidity/uniswapx/concepts/architecture | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/liquidity/uniswapx/concepts/architecture.md (native markdown) -->
# Architecture (/docs/liquidity/uniswapx/concepts/architecture)

Understand UniswapX reactors, fill contracts, and direct fill settlement paths across supported order formats.

<img alt="UniswapX architecture diagram showing the relationship between reactors, fill contracts, and order settlement" src={__img0} placeholder="blur" />
