<!-- source: https://developers.uniswap.org/docs/liquidity/liquidity-provisioning-api/integration-guide | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/liquidity/liquidity-provisioning-api/integration-guide.md (native markdown) -->
# LP API Integration Guide (/docs/liquidity/liquidity-provisioning-api/integration-guide)
...
| ----------------------------------------------------------------------- | ----------------------------------------------------------------- |
| [POST /lp/check\_approval](/docs/api-reference/check_lp_approval)       | Check token approvals and return approval transactions            |
| [POST /lp/create](/docs/api-reference/create_position)                  | Create a new Uniswap v3 or Uniswap v4 liquidity position          |
| [POST /lp/create\_classic](/docs/api-reference/create_classic_position) | Create a new Uniswap v2 liquidity position                        |
...
| [POST /lp/claim\_fees](/docs/api-reference/claim_fees)                  | Collect accumulated fees from a Uniswap v3 or Uniswap v4 position |
| [POST /lp/pool\_info](/docs/api-reference/pool_info)                    | Get current pool state for a token pair                           |
...
Uniswap v2 — /lp/create_classic [#uniswap-v2--lpcreate_classic]
...
Collecting Fees — /lp/claim_fees [#collecting-fees--lpclaim_fees]
