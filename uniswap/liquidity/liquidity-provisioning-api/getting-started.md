<!-- source: https://developers.uniswap.org/docs/liquidity/liquidity-provisioning-api/getting-started | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/liquidity/liquidity-provisioning-api/getting-started.md (native markdown) -->
# Managing Liquidity via the Uniswap API (/docs/liquidity/liquidity-provisioning-api/getting-started)
...
<img alt="Workflow for LP API messaging" src={__img0} />
