<!-- source: https://developers.uniswap.org/docs/liquidity/liquidity-launchpad/guides/exit-bid | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/liquidity/liquidity-launchpad/guides/exit-bid.md (native markdown) -->
# Exit and Claim Tokens (/docs/liquidity/liquidity-launchpad/guides/exit-bid)
