<!-- source: https://developers.uniswap.org/docs/liquidity/liquidity-launchpad/overview | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/liquidity/liquidity-launchpad/overview.md (native markdown) -->
# CCA Overview (/docs/liquidity/liquidity-launchpad/overview)

Learn how Uniswap Liquidity Launchpad uses CCA auctions and strategies to bootstrap liquidity for Uniswap v4 pools.
...
<img alt="Token Launcher Architecture" src={__img0} />
