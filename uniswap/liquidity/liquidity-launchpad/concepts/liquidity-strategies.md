<!-- source: https://developers.uniswap.org/docs/liquidity/liquidity-launchpad/concepts/liquidity-strategies | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/liquidity/liquidity-launchpad/concepts/liquidity-strategies.md (native markdown) -->
# Strategies (/docs/liquidity/liquidity-launchpad/concepts/liquidity-strategies)

Learn how Liquidity Launchpad strategy contracts deploy auctions and migrate proceeds into Uniswap v4 liquidity.
