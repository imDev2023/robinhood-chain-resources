<!-- source: https://developers.uniswap.org/docs/liquidity/liquidity-launchpad/concepts/cca | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/liquidity/liquidity-launchpad/concepts/cca.md (native markdown) -->
# Continuous Clearing Auction (/docs/liquidity/liquidity-launchpad/concepts/cca)

Understand the Continuous Clearing Auction mechanism used by Uniswap Liquidity Launchpad for token price discovery.
