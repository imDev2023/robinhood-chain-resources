<!-- source: https://developers.uniswap.org/docs/unichain/technical-information/submitting-transactions-from-l1 | captured: 2026-08-22 | via: Jina Reader (native .md endpoint returned 414) -->
# Submitting Transactions from L1

Submit transactions from Ethereum L1 to Unichain using the Optimism Portal contract.

## [Withdraw ETH via an L1 Transaction](https://developers.uniswap.org/docs/unichain/technical-information/submitting-transactions-from-l1#withdraw-eth-via-an-l1-transaction)
...
## [Unichain Contract Addresses](https://developers.uniswap.org/docs/unichain/technical-information/submitting-transactions-from-l1#unichain-contract-addresses)
...
## [Initiate a Withdrawal from L1](https://developers.uniswap.org/docs/unichain/technical-information/submitting-transactions-from-l1#initiate-a-withdrawal-from-l1)
...
## [Relaying the Withdrawal from L2 to L1](https://developers.uniswap.org/docs/unichain/technical-information/submitting-transactions-from-l1#relaying-the-withdrawal-from-l2-to-l1)
...
## [Finalizing the L1 Withdrawal](https://developers.uniswap.org/docs/unichain/technical-information/submitting-transactions-from-l1#finalizing-the-l1-withdrawal)
...
## [Submitting Arbitrary Transactions from L1](https://developers.uniswap.org/docs/unichain/technical-information/submitting-transactions-from-l1#submitting-arbitrary-transactions-from-l1)
...
1.   Use the Uniswap v2 SDK to generate the required calldata for the swap (see docs[here](https://developers.uniswap.org/docs/sdks/v2/guides/swapping))
...
[Contract Addresses](https://developers.uniswap.org/docs/unichain/technical-information/contract-addresses)[Unichain Node Snapshots](https://developers.uniswap.org/docs/unichain/technical-information/node-snapshots)

### On this page

[Withdraw ETH via an L1 Transaction](https://developers.uniswap.org/docs/unichain/technical-information/submitting-transactions-from-l1#withdraw-eth-via-an-l1-transaction)[Unichain Contract Addresses](https://developers.uniswap.org/docs/unichain/technical-information/submitting-transactions-from-l1#unichain-contract-addresses)[Initiate a Withdrawal from L1](https://developers.uniswap.org/docs/unichain/technical-information/submitting-transactions-from-l1#initiate-a-withdrawal-from-l1)[Relaying the Withdrawal from L2 to L1](https://developers.uniswap.org/docs/unichain/technical-information/submitting-transactions-from-l1#relaying-the-withdrawal-from-l2-to-l1)[Finalizing the L1 Withdrawal](https://developers.uniswap.org/docs/unichain/technical-information/submitting-transactions-from-l1#finalizing-the-l1-withdrawal)[Submitting Arbitrary Transactions from L1](https://developers.uniswap.org/docs/unichain/technical-information/submitting-transactions-from-l1#submitting-arbitrary-transactions-from-l1)
