<!-- source: https://developers.uniswap.org/docs/unichain/getting-started/set-up-a-node | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/unichain/getting-started/set-up-a-node.md (native markdown) -->
