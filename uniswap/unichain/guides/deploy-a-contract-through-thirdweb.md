<!-- source: https://developers.uniswap.org/docs/unichain/guides/deploy-a-contract-through-thirdweb | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/unichain/guides/deploy-a-contract-through-thirdweb.md (native markdown) -->
# Deploy SuperchainERC20 with thirdweb (/docs/unichain/guides/deploy-a-contract-through-thirdweb)

Deploy a SuperchainERC20 token on Unichain with thirdweb and prepare it for Uniswap trading.
...
<img alt="Explore Page" src={__img0} placeholder="blur" />
...
<img alt="Explore Modular Contracts" src={__img1} placeholder="blur" />
...
<img alt="Contract Metadata" src={__img2} placeholder="blur" />

* Select a Project to add this contract to:

<img alt="Project Add" src={__img3} placeholder="blur" />
...
<img alt="Unichain Search" src={__img4} placeholder="blur" />

* Select your desired network to deploy on

<img alt="Deploy Unichain" src={__img5} placeholder="blur" />
...
<img alt="Contract Overview" src={__img6} placeholder="blur" />

## 6. Mint tokens
* **Accessing the Modules view**: Click on the "Modules" section on the left hand side

<img alt="Modules View" src={__img7} placeholder="blur" />
...
<img alt="Mint Tokens" src={__img8} placeholder="blur" />
...
<img alt="Final Setup" src={__img9} placeholder="blur" />
