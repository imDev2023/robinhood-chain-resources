<!-- source: https://developers.uniswap.org/docs/unichain/guides/routing-on-unichain | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/unichain/guides/routing-on-unichain.md (native markdown) -->
# Routing on Unichain (/docs/unichain/guides/routing-on-unichain)

Route liquidity across Unichain with Tycho and simulate swaps across Uniswap v2, v3, and v4.
