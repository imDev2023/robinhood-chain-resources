<!-- source: https://developers.uniswap.org/docs/trading/custom-interface-links | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/trading/custom-interface-links.md (native markdown) -->
# Custom Linking (/docs/trading/custom-interface-links)

Configure Uniswap interface URL parameters for prefilled swap and pool flows in v2 integration experiences.
