<!-- source: https://developers.uniswap.org/docs/trading/swapping-api/chained-actions-integration | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/trading/swapping-api/chained-actions-integration.md (native markdown) -->
# Chained Actions Integration Guide (/docs/trading/swapping-api/chained-actions-integration)
