<!-- source: https://developers.uniswap.org/docs/trading/swapping-api/concepts/no-permit2-workflow | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/trading/swapping-api/concepts/no-permit2-workflow.md (native markdown) -->
...
> [!NOTE]
> **UniswapX is not available in this flow**
>
