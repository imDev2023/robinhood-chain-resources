<!-- source: https://developers.uniswap.org/docs/trading/swapping-api/concepts/swap-routing | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/trading/swapping-api/concepts/swap-routing.md (native markdown) -->
