<!-- source: https://developers.uniswap.org/docs/trading/swapping-api/building-prerequisites | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/trading/swapping-api/building-prerequisites.md (native markdown) -->
