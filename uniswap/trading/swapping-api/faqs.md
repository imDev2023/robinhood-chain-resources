<!-- source: https://developers.uniswap.org/docs/trading/swapping-api/faqs | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/trading/swapping-api/faqs.md (native markdown) -->
