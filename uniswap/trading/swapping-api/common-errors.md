<!-- source: https://developers.uniswap.org/docs/trading/swapping-api/common-errors | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/trading/swapping-api/common-errors.md (native markdown) -->
