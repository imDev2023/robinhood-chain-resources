<!-- source: https://developers.uniswap.org/docs/trading/swapping-api/integration-guide | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/trading/swapping-api/integration-guide.md (native markdown) -->
# Swapping API Integration Guide (/docs/trading/swapping-api/integration-guide)
