<!-- source: https://developers.uniswap.org/docs/trading/swapping-api/chained-actions | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/trading/swapping-api/chained-actions.md (native markdown) -->
# Swapping with Chained Actions (/docs/trading/swapping-api/chained-actions)
