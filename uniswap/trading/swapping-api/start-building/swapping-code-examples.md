<!-- source: https://developers.uniswap.org/docs/trading/swapping-api/start-building/swapping-code-examples | captured: 2026-09-02 | via: https://developers.uniswap.org/docs/trading/swapping-api/start-building/swapping-code-examples.md (native markdown) -->
