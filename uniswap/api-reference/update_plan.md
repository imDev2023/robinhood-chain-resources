...
`PATCH https://trade-api.gateway.uniswap.org/v1/plan/{planId}`  
operationId: `update_plan` · tags: chained-swapping
...
- `planId` (path, required): The unique identifier of the plan to update. 
