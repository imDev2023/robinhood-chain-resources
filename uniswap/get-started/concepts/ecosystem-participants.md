<!-- source: https://developers.uniswap.org/docs/get-started/concepts/ecosystem-participants | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/get-started/concepts/ecosystem-participants.md (native markdown) -->
# Ecosystem Participants (/docs/get-started/concepts/ecosystem-participants)

Explore liquidity providers, traders, and developers and their roles in the Uniswap ecosystem.

The Uniswap ecosystem includes three primary participant groups: liquidity providers, traders, and developers.

<img alt="Uniswap ecosystem participants" src={__img0} placeholder="blur" />
