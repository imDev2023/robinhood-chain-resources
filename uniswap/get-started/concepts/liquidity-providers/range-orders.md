<!-- source: https://developers.uniswap.org/docs/get-started/concepts/liquidity-providers/range-orders | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/get-started/concepts/liquidity-providers/range-orders.md (native markdown) -->
# Range Orders (/docs/get-started/concepts/liquidity-providers/range-orders)

Learn how range orders approximate limit orders using single-sided liquidity in Uniswap AMMs.
...
<img alt="RangeOrder1" src={__img0} placeholder="blur" />
       
<img alt="RangeOrder1" src={__img1} placeholder="blur" />
