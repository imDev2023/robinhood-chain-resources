<!-- source: https://developers.uniswap.org/docs/get-started/concepts/liquidity-providers/concentrated-liquidity | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/get-started/concepts/liquidity-providers/concentrated-liquidity.md (native markdown) -->
# Concentrated Liquidity (/docs/get-started/concepts/liquidity-providers/concentrated-liquidity)
