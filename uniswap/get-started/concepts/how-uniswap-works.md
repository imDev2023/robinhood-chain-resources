<!-- source: https://developers.uniswap.org/docs/get-started/concepts/how-uniswap-works | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/get-started/concepts/how-uniswap-works.md (native markdown) -->
# How Uniswap Works (/docs/get-started/concepts/how-uniswap-works)

Learn how Uniswap AMMs work across all protocol versions.
...
<img alt="Uniswap AMM pool anatomy" src={__img0} placeholder="blur" />
...
<img alt="Liquidity provider deposits into a Uniswap pool" src={__img1} placeholder="blur" />
...
<img alt="Token swap against Uniswap pool reserves" src={__img2} placeholder="blur" />
