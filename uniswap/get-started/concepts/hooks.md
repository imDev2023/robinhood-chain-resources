<!-- source: https://developers.uniswap.org/docs/get-started/concepts/hooks | captured: 2026-08-22 | via: https://developers.uniswap.org/docs/get-started/concepts/hooks.md (native markdown) -->
# Hooks (/docs/get-started/concepts/hooks)
